...
Tags must be declared with the \T{enum} instruction.
...
In the case where this argument is a tuple, it may de destructured
...
\subsection{Iteration over sets}
...
\subsection{Candidate execution extension}
...
of element~$e$ in~$S$ in a contex extended by a binding
of the name~\nt{id} to~$e$.
