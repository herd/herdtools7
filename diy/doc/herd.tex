...
\item and read events read from the most recent write events in the past,
...
\end{itemize}
In other words, \verb+S+ is a topological order on memory events that extends~\verb+po+,
while \verb+rf+ is defined (thanks to initial writes) without ambiguity.
