...
module Make (C : sig
  ...
  module AArch64Cst = SymbConstant.Make (Int64Scalar) (AArch64PteVal) (AArch64IntidVal) (AArch64I)
  module NoCst = SymbConstant.Make (Int64Scalar) (PteVal.No) (IntidVal.No) (AArch64I)
