...
| TOK_F COLON f=NUM tail=addrregval_update_tail
    { ParsedAddrReg.add_kv "f" f tail }
...
| loc=left_loc EQUAL v=addrregval
  { (loc,(Ty "parel1_t", MiscParser.add_oa_if_none_addrreg loc v)) }
