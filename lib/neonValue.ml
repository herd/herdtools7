...
module Make (C : sig
  ...
  module AArch64Cst =
    SymbConstant.Make (Int128Scalar) (AArch64PteVal) (AArch64Instr)
  module NoCst =
    SymbConstant.Make (Int128Scalar) (PteVal.No)(AArch64Instr)
  module NoArchOp = ArchOp.No(NoCst)
  module AArch64Op = AArch64Op.Make (Int128Scalar)(NoArchOp)
