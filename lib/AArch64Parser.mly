...
| TOK_ASR xreg COMMA xreg COMMA op_ext_x
  { I_OP3 (V64, ASR, $2, $4, $6) }
| TOK_ASR wreg COMMA wreg COMMA op_ext_w
  { I_OP3 (V32, ASR, $2, $4, $6) }
| TOK_LSL xreg COMMA xreg COMMA op_ext_x
  { I_OP3 (V64, LSL, $2, $4, $6) }
| TOK_LSL wreg COMMA wreg COMMA op_ext_w
  { I_OP3 (V32, LSL, $2, $4, $6) }
| TOK_LSR xreg COMMA xreg COMMA op_ext_x
  { I_OP3 (V64, LSR, $2, $4, $6) }
| TOK_LSR wreg COMMA wreg COMMA op_ext_w
  { I_OP3 (V32, LSR, $2, $4, $6) }
...
| TOK_ADD xreg COMMA xreg COMMA op_ext_x
  { I_OP3 (V64,ADD,$2,$4,$6) }
| TOK_ADD wreg COMMA wreg COMMA op_ext_w
  { I_OP3 (V32,ADD,$2,$4,$6) }
| TOK_ADD creg COMMA creg COMMA op_ext_c
  { I_OP3 (V128,ADD,$2,$4,$6) }
| TOK_ADD creg COMMA creg COMMA xreg COMMA add_sub_ext
  { I_ADDSUBEXT (V128,Ext.ADD,$2,$4,(V64,$6),$8) }
| TOK_ADD xreg COMMA xreg COMMA wxreg COMMA add_sub_ext
  { I_ADDSUBEXT (V64,Ext.ADD,$2,$4,$6,$8) }
| TOK_ADD wreg COMMA wreg COMMA wreg COMMA add_sub_ext
  { I_ADDSUBEXT (V32,Ext.ADD,$2,$4,(V32,$6),$8) }
(* ADDS, idem *)
| TOK_ADDS xreg COMMA xreg COMMA op_ext_x
  { I_OP3 (V64,ADDS,$2,$4,$6) }
| TOK_ADDS wreg COMMA wreg COMMA op_ext_w
  { I_OP3 (V32,ADDS,$2,$4,$6) }
| TOK_ADDS creg COMMA creg COMMA op_ext_c
  { I_OP3 (V128,ADDS,$2,$4,$6) }
| TOK_ADDS creg COMMA creg COMMA xreg COMMA add_sub_ext
  { I_ADDSUBEXT (V128,Ext.ADDS,$2,$4,(V64,$6),$8) }
| TOK_ADDS xreg COMMA xreg COMMA wxreg COMMA add_sub_ext
  { I_ADDSUBEXT (V64,Ext.ADDS,$2,$4,$6,$8) }
| TOK_ADDS wreg COMMA wreg COMMA wreg COMMA add_sub_ext
  { I_ADDSUBEXT (V32,Ext.ADDS,$2,$4,(V32,$6),$8) }
(* Substraction *)
| TOK_SUB xreg COMMA xreg COMMA op_ext_x
  { I_OP3 (V64,SUB,$2,$4,$6) }
| TOK_SUB wreg COMMA wreg COMMA op_ext_w
  { I_OP3 (V32,SUB,$2,$4,$6) }
| TOK_SUB creg COMMA creg COMMA op_ext_c
  { I_OP3 (V128,SUB,$2,$4,$6) }
| TOK_SUB creg COMMA creg COMMA xreg COMMA add_sub_ext
  { I_ADDSUBEXT (V128,Ext.SUB,$2,$4,(V64,$6),$8) }
| TOK_SUB xreg COMMA xreg COMMA wxreg COMMA add_sub_ext
  { I_ADDSUBEXT (V64,Ext.SUB,$2,$4,$6,$8) }
| TOK_SUB wreg COMMA wreg COMMA wreg COMMA add_sub_ext
  { I_ADDSUBEXT (V32,Ext.SUB,$2,$4,(V32,$6),$8) }
(* SUBS, idem *)
| TOK_SUBS xreg COMMA xreg COMMA op_ext_x
  { I_OP3 (V64,SUBS,$2,$4,$6) }
| TOK_SUBS wreg COMMA wreg COMMA op_ext_w
  { I_OP3 (V32,SUBS,$2,$4,$6) }
| TOK_SUBS creg COMMA creg COMMA op_ext_c
  { I_OP3 (V128,SUBS,$2,$4,$6) }
| TOK_SUBS creg COMMA creg COMMA xreg COMMA add_sub_ext
  { I_ADDSUBEXT (V128,Ext.SUBS,$2,$4,(V64,$6),$8) }
| TOK_SUBS xreg COMMA xreg COMMA wxreg COMMA add_sub_ext
  { I_ADDSUBEXT (V64,Ext.SUBS,$2,$4,$6,$8) }
| TOK_SUBS wreg COMMA wreg COMMA wreg COMMA add_sub_ext
  { I_ADDSUBEXT (V32,Ext.SUBS,$2,$4,(V32,$6),$8) }
