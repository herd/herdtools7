...
module Make(A:I) =
  struct
    ...
    let pp_fault (lbl,x,_ftype,msg) = match msg with
    | Some msg ->
    ...
    let compare (lbl1,x1,_ftype,msg1) (lbl2,x2,_ftype,msg2) = match compare_lbl lbl1 lbl2 with
    | 0 ->
    ...
    let check_one_fatom ((p0,lbls0),x0,_ftype0,_)  ((p,lblo),x) =
      Proc.compare p p0 = 0 &&
