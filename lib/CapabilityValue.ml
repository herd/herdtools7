...
module Make (C : sig
  ...
  module AArch64Constant =
    SymbConstant.Make (CapabilityScalar) (AArch64PteVal) (AArch64AddrReg)
      (AArch64IntidVal) (AArch64Instr)
  module NoCst =
    SymbConstant.Make (CapabilityScalar) (PteVal.No) (AddrReg.No) (IntidVal.No)
      (AArch64Instr)
