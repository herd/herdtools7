      ...
      let eiid,acts =
        Evt.fold
          (fun (a,cl_a,es_rn) (eiid,acts) ->
            ...
            assert (E.is_empty_event_structure eseq) ;
            let es =
              E.aarch64_cas is_physical `DataFromRx es_rn es_rs es_rm es_wrs es_rm es_wm es_br in
...
(* AArch64 successful cas *)
    let do_aarch64_cas_ok
        (is_physical:bool) (prov_data: [`DataFromRRs | `DataFromRx | `NoWriteRt])
...
(* Simple alternative *)
    ...
    let aarch64_cas_no (is_physical: bool) (read_rn: 'loc t)
      ...
      do_aarch64_cas_no is_physical read_rn read_rs
