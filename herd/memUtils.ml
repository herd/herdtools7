...
(* Collect various events by their location *)
  ...
  and collect_sysreg_loads es = collect_by_loc es E.is_sysreg_load_any
  and collect_sysreg_stores es = collect_by_loc es E.is_sysreg_store_any
  and collect_non_sysreg_loads es = collect_by_loc es E.is_non_sysreg_load_any
