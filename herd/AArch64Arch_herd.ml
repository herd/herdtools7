...
module Make (C:Arch_herd.Config)(V:Value.AArch64) =
  struct
    ...
    *     B, B.cond, BL, BRK, CB<cc>, CBB<cc>, CBH<cc>, CBNZ, CBZ, HVC, ISB,
    *     NOP, SMC, SVC, TBNZ, TBZ, TRCIT, or UDF.
    ...
    *)
    ...
    | I_SWP _| I_SWPBH _| I_SXTW _| I_TLBI _ | I_AT _ | I_UBFM _| I_UNSEAL _ | I_ADDSUBEXT _ | I_ABS _ | I_REV _ | I_EXTR _
    | I_MOPL _ | I_MOP _
    ...
    let killed i =
      ...
      | I_STG (_,r,idx)|I_ST2G (_,r,idx)|I_STZG (_,r,idx)|I_STZ2G (_,r,idx)
      | I_STP (_,_,_,_,r,idx) ->
          killed_idx r idx []
    ...
    let get_lx_sz = function
      ...
      | I_STG _|I_ST2G _|I_STZG _|I_STZ2G _|I_LDG _|I_UDF _|I_IRG _
