 ...
 *)
    ...
    let p1a3r name param1 arg1 arg2 arg3 ~returns  f =
      let f ii_env params args =
        match params,args with
    ...
    let p1a4 name param1 arg1 arg2 arg3 arg4 f =
      let f ii_env params args =
        match params,args with
    ...
    let extra_funcs =
      ...
      [
        ...
        p1 "on_read_resaddr" ("data", bv_64) on_read_resaddr;
        p1 "on_write_resaddr" ("data", bv_64) on_write_resaddr;
