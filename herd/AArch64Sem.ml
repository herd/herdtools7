...
(* KVM mode *)
      ...
      let do_lift_kvm dir updatedb mop ma an ii mphy mfault =
        let maccess a ma =
      ...
      let lift_kvm dir updatedb mop ma an ii mphy =
        ...
        do_lift_kvm dir updatedb mop ma an ii mphy mfault
...
*)
      ...
      let do_at op rd ii =
        ...
        do_lift_kvm dir false mop ma Annot.N ii mphy mfault
