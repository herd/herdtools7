...
\texttt{t,new\_env} or an error and all of the following apply:
  ...
  \item an error ``\texttt{Typing Assumption Failed}'' or \texttt{t\_index'} type-satisfies \texttt{wanted\_t\_index} as per Section~\ref{sec:TypingRule.TypeSatisfaction} and all of the following apply:
  ...
  \subsection{Prose}
   ...
   \item One of the following applies:
     ...
     \item All of the following apply:
           ...
           \item \texttt{new\_p} is the pattern which matches anything greater than or equal to \texttt{e'}.
           \end{itemize} 
     \item an error ``\texttt{Conflict Types}'' is raised.
     \end{itemize}
   \end{itemize}
...
environment \texttt{new\_env} and all of the following apply:
  ...
  \subsection{Comments}
  Note that LRM R\_BRCJ is done at runtime.
