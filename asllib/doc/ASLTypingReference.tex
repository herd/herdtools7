...
\and
\inferrule{}{ \dynamicdomain(\tenv, \denv, \TBits(c, \textit{bfl})) = \\ \{ b_1\cdot\ldots\cdot b_k \;|\; b_1,\ldots,b_k \in \{0,1\}, \;\;\; k \in \evalconstraint{\tenv, E, c} \} }
\and
\inferrule{}{ \dynamicdomain(\tenv, \denv, \TTuple([\tty_{1..k}])) = \bigtimes_{i=1}^k \dynamicdomain(\tenv, \denv,\tty_i) }
\and
\inferrule{}{ \dynamicdomain(\tenv, \denv, \TArray(\ve, \tty)) = \\ \{ v_1\cdot\ldots\cdot v_k\;|\; k = \evalexpr{E, \ve}, \; v_{1..k} \in \dynamicdomain(\tenv, \denv, \tty)  \} }
\and
