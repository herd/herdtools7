...
This aims to encompass \identr{VDPC}.
...
\end{formal}
    ...
    \subsection{Comments}
    This aims to encompass \identd{PQCK} and \identd{NZWT}.
...
\end{formal}
    ...
    \subsection{Comments}
    This aims to encompass \identd{PQCK} and \identd{KNBD}.
...
\end{formal}
    ...
    \subsection{Comments}
    This aims to encompass \identd{vmzx}.
...
\end{formal}
    ...
    \subsection{Comments}
    This aims to encompass \identr{GVZK}.
...
\end{formal}
    ...
    \subsection{Comments}
    This aims to encompass \identd{GWXK}.
...
\end{emptyformal}
    ...
    This aims to encompass \identd{FXQV}.
...
\end{emptyformal}
  ...
  \subsection{Comments}
  This aims to encompass \identd{BMGM}.
...
\subsection{Comments}
    This aims to encompass \identd{ZTPP}, \identr{WJYH}, \identr{HJPN}, \identr{CZTX}, \identr{TPHR}
...
\newcommand\super[0]{\textit{super}}
  ...
  This aims to encompass \identr{NXRX}, \identi{KGKS}, \identi{MTML}, \identi{JVRM}, \identi{CHMP}.
...
\subsection{Comments}
  ...
  This aims to encompass \identi{KGKS}.
...
\subsection{Comments}
  This aims to encompass \identd{TRVR}.
...
\subsection{Comments}
  ...
  This aims to encompass \identr{FMXK} and \identi{NLFD}.
...
\subsection{Comments}
  This aims to encompass \identr{GNTS} and \identr{LXQZ}.
...
\subsection{Comments}
  ...
  This aims to encompass \identd{VPZZ}, \identi{PQCT} and \identi{WZKM}.
...
\subsection{Comments}
    This aims to encompass \identr{YZHM}.
...
\subsection{Comments}
  This aims to encompass \identr{BKNT}, \identr{ZYWY}, \identr{BZKW},
  \identr{KFYS}, \identr{KXMR}, \identr{SQXN}, \identr{MRHT}.
...
\subsection{Comments}
  This aims to encompass \identr{XZVT}.
...
\isempty{\subsection{Comments}}
  ...
  This aims to encompass \identr{WBCQ}.
...
\subsection{Comments}
  This aims to encompass \identr{NYNK} and \identr{KCZS}.
...
This aims to encompass \identr{YSPM}.
...
\subsection{Comments}
    This aims to encompass \identr{FTPK}.
...
\subsection{Comments}
    This aims to encompass \identr{NBDJ}.
...
\subsection{Comments}
    This aims to encompass \identr{WGSY}.
...
\subsection{Comments}
    This aims to encompass \identr{JQYF}
...
\subsection{Comments}
    This aims to encompass \identr{FTVN}.
...
\subsection{Comments}
    This aims to encompass \identr{VTJW}.
...
\subsection{Comments}
    This aims to encompass \identr{NXRC}.
...
\subsection{Comments}
    This aims to encompass \identr{WVXS}.
...
\subsection{Comments}
    This aims to encompass \identr{SDJK}.
