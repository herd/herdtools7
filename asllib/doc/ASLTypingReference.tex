...
a \emph{static environment} and a \emph{typed AST}, which are used in defining the ASL semantics (\partref{ASLSemanticsReference}).
...
of the ASL semantics appears in \partref{FormalSystem} and \chapref{typesystembuildingblocks}.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
This chapter is concerned with implementing a \hyperlink{def-soundsubsumptiontest}{sound subsumption test} for integer types, as defined in \secref{subsumptiontesting} and employed by
...
We assume that both $\vt$ and $\vs$ have been successfully annotated to integer types as per \chapref{typingoftypes}
...
\section{TypingRule.SymDomOfWidth \label{sec:TypingRule.SymDomOfWidth}}
