...
\inferrule[type\_equal]{
  ...
  \annotateexpr{\tenv, \overname{\EATC(\vep, \tty)}{\ve}} \typearrow (\overname{\tty'}{\ve}, \overname{\vepp}{\newe})
}
\end{mathpar}
...
\inferrule[dynamic]{
  ...
  \annotateexpr{\tenv, \overname{\EATC(\vep, \tty)}{\ve}} \typearrow (\overname{\vtp}{\vt}, \overname{\EATC(\vepp, \vtystruct)}{\newe})
}
\end{mathpar}
...
\inferrule[error]{
  ...
  \annotateexpr{\tenv, \overname{\EATC(\vep, \tty)}{\ve}} \typearrow \TypeErrorVal{ATC}
}
\end{mathpar}
