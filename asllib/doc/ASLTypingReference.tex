...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item define $\newe$ as the the call expression for subprogram $\vx$ with arguments $\vargsp$ and parameter expressions $\paramargs$,
    ...
    \begin{itemize}
      ...
      \begin{itemize}
        ...
        \item checking that $\callerty$ is a constrained integer in $\tenv$ yields \\
              $\True$\ProseOrTypeError;
        \item applying $\annotateparameterdefining$ to $\vargsone$, $\callerargstypedone$, $\eqsone$ in $\tenv$
              yields $\eqstwo$\ProseOrTypeError;
...
\begin{itemize}
  ...
  \item $\annotateddecls$ is the list with $\newd$ as its \head\ and $\decls$ as its \tail.
\end{itemize}
...
\begin{itemize}
  ...
  \item $\annotateddecls$ is the list with $\vd$ as its \head\ and $\decls$ as its \tail.
  \end{itemize}
