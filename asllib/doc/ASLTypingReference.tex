...
distinct components: the global environment---pertaining to AST nodes appearing
outside of a given subprogram, and the local environment---pertaining to AST
nodes appearing inside a given subprogram.
...
of the auxiliary attributes alluded to above. We define these in the next
chapter. 
