...
\ASLListing{Valid applications of unary operations}{unary-operations}{\typingtests/TypingRule.UnopLiterals.asl}
...
\subsubsection{Example (Integer Relational)\label{sec:IntegerRelational}}
\listingref{binary-operations-integer-relational} shows applications
of relational integer operations to literals (invalid applications in comments),
followed by the resulting console output.
\ASLListing{Applications of relational integer operations}
...
followed by the resulting console output.
\ASLListing{Applications of operations on real-typed literals}
  {binary-operations-real}
  {\typingtests/TypingRule.BinopLiterals.real.asl}

% ASL_RUN_BEGIN: aslref \typingtests/TypingRule.BinopLiterals.real.asl
\begin{small}
\begin{verbatim}
