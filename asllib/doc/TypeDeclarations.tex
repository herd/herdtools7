...
\subsection{TypingRule.DeclareType \label{sec:TypingRule.DeclareType}}
...
\subsection{TypingRule.AnnotateExtraFields \label{sec:TypingRule.AnnotateExtraFields}}
...
\subsection{TypingRule.AnnotateTypeOpt \label{sec:TypingRule.AnnotateTypeOpt}}
...
\subsection{TypingRule.AnnotateExprOpt \label{sec:TypingRule.AnnotateExprOpt}}
...
\subsection{TypingRule.AnnotateInitType \label{sec:TypingRule.AnnotateInitType}}
...
\subsection{TypingRule.AnnotateEnumLabels \label{sec:TypingRule.AnnotateEnumLabels}}
...
\subsection{TypingRule.DeclareConst \label{sec:TypingRule.DeclareConst}}
