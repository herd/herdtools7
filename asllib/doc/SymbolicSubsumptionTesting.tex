...
%
In particular, it serves as the definitive domain subset test that must be utilised
...
\SectionDef[defines a symbolic representation for sets of integers; and]
  {Symbolic Domains}{Symbolic Domains}
...
\SectionDef[defines the symbolic reasoning used for domain subset
        testing.]
  {Symbolic Reasoning}{Symbolic Reasoning}
We define the following rules for symbolic subsumption testing:
\begin{TypingRuleList}{SymbolicSubsumptionTesting}

\TypingRuleDef[checks symbolic subsumption between lists of symbolic domains.]{SymdomSubsetUnions}
...
\TypingRuleDef[normalizes a \symbolicdomainterm{}.]{SymdomNormalize}
\RenderRelation{symdom_normalize}

\ExampleDef{Normalising Symbolic Domains}
In \listingref{SymdomOfConstraint}, normalising the \symbolicdomainterm{} for the type\\
...
\TypingRuleDef[defines the \symbolicdomainterm{} of a type.]{SymdomOfType}
...
\TypingRuleDef[defines the \symbolicdomainterm{} of a bitwidth expression.]{SymdomOfWidthExpr}
...
\TypingRuleDef[defines the \symbolicdomainterm{} of a constraint.]{SymdomOfConstraint}
...
\TypingRuleDef[evaluates expressions used to construct symbolic domains.]{SymdomEval}
...
\TypingRuleDef[checks whether one \symbolicdomainterm{} subsumes another.]{SymdomSubset}
...
\TypingRuleDef[approximates a list of constraints.]{ApproxConstraints}
...
\TypingRuleDef[approximates a constraint.]{ApproxConstraint}
...
\TypingRuleDef[approximates an integer interval.]{MakeInterval}
...
\TypingRuleDef[approximates the minimal value of an expression.]{ApproxExprMin}
...
\TypingRuleDef[approximates the maximal value of an expression.]{ApproxExprMax}
...
\TypingRuleDef[defines approximation results for bottom and top bounds.]{ApproxBottomTop}
...
\TypingRuleDef[converts an integer set into a list of constraints.]{IntsetToConstraints}
...
\TypingRuleDef[approximates an expression.]{ApproxExpr}
...
\TypingRuleDef[approximates binary operations over constraint lists.]{ApproxConstraintBinop}
...
\TypingRuleDef[approximates a type.]{ApproxType}
...
\TypingRuleDef[generates constraints for binary operations.]{ConstraintBinop}
...
\TypingRuleDef[generates constraints from binary operations over range extremities.]{ApplyBinopExtremities}
...
\TypingRuleDef[generates constraints when the left operand has range extremities.]{PossibleExtremitiesLeft}
...
\TypingRuleDef[generates constraints when the right operand has range extremities.]{PossibleExtremitiesRight}
...
\TypingRuleDef[generates constraints for modulus operations.]{ConstraintMod}
...
\TypingRuleDef[generates constraints for exponentiation operations.]{ConstraintPow}
