...
We also use the symbol \RenderConstant{CannotOverapproximate} to mean that a construct
(like an expression or a constraint) cannot be precisely overapproximated,
and \RenderConstant{CannotUnderapproximate} to mean that a construct cannot be precisely
underapproximated.
...
\inferrule{
  ...
  \ifthenelsestmt{a=b}{\AbbrevConstraintExact{\ELInt{a}}}{\AbbrevConstraintRange{\ELInt{a}}{\ELInt{b}}}
    \right]
  }
}{
