...
\newcommand{\RenderConstant}[2][]{%
  \@ifundefined{RenderConstant@#2}{%
    \PackageError{rendering_macros}{RenderConstant '#2' not defined! Check that you have defined constant '#2' and applied aslspec to generate \string\DefineConstant}{}%
  }{%
...
\newcommand{\RenderType}[2][]{%
  \@ifundefined{RenderType@#2}{%
    \PackageError{rendering_macros}{RenderType '#2' not defined! Check that you have defined type '#2' and applied aslspec to generate \string\DefineType}{}%
  }{%
...
\newcommand{\RenderRelation}[1]{%
  \@ifundefined{RenderRelation@#1}{%
    \PackageError{rendering_macros}{RenderRelation '#1' not defined! Check that you have defined relation '#1' using \string\DefineRelation}{}%
  }{%
...
\newcommand{\RenderTypes}[2][]{%
  \@ifundefined{RenderTypes@#2}{%
    \PackageError{rendering_macros}{RenderTypes '#2' not defined! Check that you have defined render '#2' and applied aslspec to generate \string\DefineRenderTypes}{}%
  }{%
