...
%% \RenderConstant{name}[options] - Render the defined constant
%%   Usage:
%%     \RenderConstant{constantname}                    - Render single constant
%%     \RenderConstant[remove_hypertargets]{constant1}  - Remove \hypertarget{...}{} commands from output   % DO NOT LINT
%%
...
\newcommand{\RenderConstant}[2][]{%
  \@ifundefined{RenderConstant@#2}{%
    \textbf{Error: RenderConstant '#2' not defined}%
  }{%
