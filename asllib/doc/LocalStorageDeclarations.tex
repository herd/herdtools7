...
\ASLListing{}{semantics-}{\semanticstests/SemanticsRule.LDVar0.asl}
\texttt{var x = 3;} binds \texttt{x} to the evaluation of \texttt{3} in $\env$.

\subsubsection{Example}
In the specification:
\ASLListing{}{semantics-}{\semanticstests/SemanticsRule.LDVar1.asl}
...
\subsubsection{Example}
In the specification:
\ASLListing{}{semantics-}{\semanticstests/SemanticsRule.LDTuple.asl}
