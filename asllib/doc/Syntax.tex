...
\begin{itemize}
  ...
  \item \secref{PriorityAndAssociativity} defines the priority and associativity
        of tokens; and
  \item \secref{GrammarExamples} presents examples showing how the grammar and
...
The rule for the unary minus operation (see $\Nunop$) is not assigned the priority
...
\section{Grammar Examples\label{sec:GrammarExamples}}
