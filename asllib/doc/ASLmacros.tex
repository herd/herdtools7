...
\newcommand\buildqualifier[0]{\hyperlink{relation-buildqualifier}{\textfunc{build\_func\_qualifier}}} % SPECIFICATION_DEFERRED
\newcommand\Prosebuildast[2]{\hyperlink{relation-buildast}{building} an untyped AST from the parse tree #1 yields #2}
\newcommand\Proserenamelocalsname[2]{\hyperlink{relation-renamelocalsname}{renaming}
  the identifier #1 yields the identifier #2}
\newcommand\Proserenamelocalsdecl[2]{\hyperlink{relation-renamelocalsdecl}{renaming}
  the local storage elements in declaration #1 yields the declaration #2}
\newcommand\Proserenamelocalsfunc[2]{\hyperlink{relation-renamelocalsfunc}{renaming}
  the local storage elements in subprogram description #1 yields the function description #2}
\newcommand\Proserenamelocalsargs[2]{\hyperlink{relation-renamelocalsargs}{renaming}
  the list of local arguments #1 yields the list of arguments #2}
\newcommand\Proserenamelocalsnamedargs[2]{\hyperlink{relation-renamelocalsnamedargs}{renaming}
  the local storage elements in the list of parameters #1 yields the list of parameters #2}
\newcommand\Proserenamelocalsstmt[2]{\hyperlink{relation-renamelocalsstmt}{renaming}
  the local storage elements in the statement #1 yields the statement #2}
\newcommand\Proserenamelocalsexpr[2]{\hyperlink{relation-renamelocalsexpr}{renaming}
  the local storage elements in the expression #1 yields the expression #2}
\newcommand\Proserenamelocalslexpr[2]{\hyperlink{relation-renamelocalslexpr}{renaming}
  the local storage elements in the assignable expression #1 yields the
  assignable expression #2}
\newcommand\Proserenamelocalsldi[2]{\hyperlink{relation-renamelocalsldi}{renaming}
  the local storage elements in the local declaration item #1 yields
  the local declaration item #2}
\newcommand\Proserenamelocalsty[2]{\hyperlink{relation-renamelocalsty}{renaming}
