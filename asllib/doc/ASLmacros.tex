...
\newcommand\torexpr[0]{\hyperlink{relation-rexpr}{\textfunc{rexpr}}} % SPECIFICATION_REQUIRED
...
\newcommand\typesatisfies[0]{\hyperlink{relation-typesatisfies}{\textfunc{type\_satisfies}}}
...
\newcommand\maskmatch[0]{\hyperlink{relation-maskmatch}{\textfunc{mask\_match}}} % REQUIRES_SPECIFICATION
\newcommand\evallocaldecl[0]{\hyperlink{relation-evallocaldecl}{\textfunc{eval\_local\_decl}}} % REQUIRES_SPECIFICATION
\newcommand\ldituplefolder[0]{\hyperlink{relation-ldituplefolder}{\textfunc{ldi\_tuple\_folder}}} % REQUIRES_SPECIFICATION
\newcommand\poplocalscope[0]{\hyperlink{relation-poplocalscope}{\textfunc{pop\_local\_scope}}} % REQUIRES_SPECIFICATION
...
\newcommand\lexprisvar[0]{\hyperlink{relation-lexprisvar}{\textfunc{lexpr\_is\_var}}} % REQUIRES_SPECIFICATION
...
\newcommand\findcatcher[0]{\hyperlink{relation-findcatcher}{\textfunc{find\_catcher}}} % REQUIRES_SPECIFICATION
...
\newcommand\outputtoconsole[0]{\hyperlink{relation-outputtoconsole}{\textfunc{output\_to\_console}}} % REQUIRES_SPECIFICATION
\newcommand\literaltostring[0]{\hyperlink{relation-literaltostring}{\textfunc{literal\_to\_string}}} % REQUIRES_SPECIFICATION
...
\newcommand\isbuiltinsingular[0]{\hyperlink{relation-isbuiltinsingular}{\textfunc{is\_builtin\_singular}}}
\newcommand\isnamed[0]{\hyperlink{relation-isnamed}{\textfunc{is\_named}}}
\newcommand\isanonymous[0]{\hyperlink{relation-isanonymous}{\textfunc{is\_anonymous}}}
\newcommand\issingular[0]{\hyperlink{relation-issingular}{\textfunc{is\_singular}}}
\newcommand\isstructured[0]{\hyperlink{relation-isstructured}{\textfunc{is\_structured}}}
...
\newcommand\staticeval[0]{\hyperlink{relation-staticeval}{\textfunc{static\_eval}}} % SPECIFICATION_REQUIRED
...
\newcommand\checktypesat[0]{\hyperlink{relation-checktypesat}{\textfunc{checked\_typesat}}} % SPECIFICATION_REQUIRED
...
\newcommand\lca[0]{\hyperlink{relation-lowestcommonancestor}{\textfunc{lowest\_common\_ancestor}}} % SPECIFICATION_REQUIRED
...
\newcommand\bitfieldsincluded[0]{\hyperlink{relation-bitfieldsincluded}{\textfunc{bitfields\_included}}}
...
\newcommand\widthplus[0]{\hyperlink{relation-widthplus}{\textfunc{width\_plus}}} % SPECIFICATION_REQUIRED
\newcommand\assocopt[0]{\hyperlink{def-assocopt}{\textfunc{assoc\_opt}}} % SPECIFICATION_DEFERRED
\newcommand\annotatefieldinit[0]{\hyperlink{relation-annotatefieldinit}{\textfunc{annotate\_field\_init}}} % SPECIFICATION_REQUIRED
...
\newcommand\checkstructurelabel[0]{\hyperlink{relation-checkstructurelabel}{\textfunc{check\_structure}}} % SPECIFICATION_REQUIRED
\newcommand\checkunderlyinginteger[0]{\hyperlink{relation-checkunderlyinginteger}{\textfunc{check\_underlying\_integer}}} % SPECIFICATION_REQUIRED
\newcommand\checksymbolicallyevaluable[0]{\hyperlink{relation-checksymbolicallyevaluable}{\textfunc{check\_symbolically\_evaluable}}} % SPECIFICATION_REQUIRED
...
\newcommand\findbitfieldsslices[0]{\hyperlink{relation-findbitfieldsslices}{\textfunc{find\_bitfields\_slices}}} % SPECIFICATION_REQUIRED
...
\newcommand\sideeffectispure[0]{\hyperlink{relation-sideeffectispure}{\textfunc{side\_effect\_is\_pure}}} % SPECIFICATION_REQUIRED
\newcommand\sideeffectisreadonly[0]{\hyperlink{relation-sideeffectisreadonly}{\textfunc{side\_effect\_is\_readonly}}} % SPECIFICATION_REQUIRED
\newcommand\sideeffectissymbolicallyevaluable[0]{\hyperlink{relation-sideeffectissymbolicallyevaluable}{\textfunc{side\_effect\_symbolically\_evaluable}}} % SPECIFICATION_REQUIRED
...
\newcommand\mulpolynomials[0]{\hyperlink{relation-mulpolynomials}{\textfunc{mul\_polynomials}}} % REQUIRES_SPECIFICATION
\newcommand\polynomialdividebyterm[0]{\hyperlink{relation-polynomialdividebyterm}{polynomial\_divide\_by\_term}} % REQUIRES_SPECIFICATION


\newcommand\fieldnames[0]{\hyperlink{relation-fieldnames}{\textfunc{field\_names}}} % REQUIRES_SPECIFICATION
\newcommand\fieldtype[0]{\hyperlink{relation-fieldtype}{\textfunc{field\_type}}} % REQUIRES_SPECIFICATION
...
\newcommand\explodeconstraint[0]{\hyperlink{relation-explodeconstraint}{\textfunc{explode\_constraint}}} % REQUIRES_SPECIFICATION
...
\newcommand\annotateslice[0]{\hyperlink{relation-annotateslice}{\textfunc{annotate\_slice}}} % REQUIRES_SPECIFICATION
\newcommand\annotatelocaldeclitem[0]{\hyperlink{relation-annotatelocaldeclitem}{\textfunc{annotate\_local\_decl\_item}}} % REQUIRES_SPECIFICATION
...
\newcommand\bintounsigned[0]{\hyperlink{relation-bintounsigned}{\textsf{binary\_to\_unsigned}}} % REQUIRES_SPECIFICATION
\newcommand\inttobits[0]{\hyperlink{relation-inttobits}{\textfunc{int\_to\_bits}}} % REQUIRES_SPECIFICATION
