...
\newcommand\reverseeqdef[0]{\hyperlink{def-eqdef}{=:}}
...
\newcommand\mapapplyoptname[0]{\hyperlink{relation-map_apply_opt}{\textfunc{map\_apply\_opt}}}
\newcommand\mapapplyoptop[3][H]{
  \ifthenelse{\equal{#1}{H}}{
    \mapapplyoptname\left({#2}, {#3}\right)
  }{
    \mapapplyoptname\left(\begin{array}{l}{#2},\\ {#3}\end{array}\right)
  }
}
...
\newcommand\AbbrevECond[4][H]{
  \ifthenelse{\equal{#1}{H}}{
  \overbracket{\texttt{if }#2\texttt{ then }#3\texttt{ else }#4}^{\hyperlink{def-abbrevebcond}{\abbrevfont{E\_Cond}}}
  }{
  \overbracket{
    \begin{array}{c}
      \texttt{if }#2\\
      \texttt{ then }#3\\
      \texttt{ else }#4
    \end{array}}^{\hyperlink{def-abbrevebcond}{\abbrevfont{E\_Cond}}}
  }
}
...
\newcommand\stringofnatname[0]{\hyperlink{relation-stringofnat}{\texttt{string\_of\_nat}}}
\newcommand\stringofnat[1]{\stringofnatname(#1)}
