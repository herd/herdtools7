...
when a property on \emph{associative operators} holds (see \ASTRuleRef{CheckNotSamePrec}).
...
which means the type-checker rule \TypingRuleRef{ATC} was already applied,
...
\subsubsection{SemanticsRule.IsConstraintSat}
