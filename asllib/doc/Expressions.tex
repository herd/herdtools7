...
evaluating the array access expression \verb|my_array[[3]]| results in a \ErrorConfigurationTerm{},
...
does not yield a \ErrorConfigurationTerm{}, since the invocation of \texttt{f1} returns $\False$ when
evaluated:
...
\item \OneApplies
      ...
      \item \AllApplyCase{error}
            ...
            \item the result is a \ErrorConfigurationTerm{} indicating that the type assertion failed
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      ...
      \item the result is a \ErrorConfigurationTerm{} (\ArbitraryEmptyType) indicating that the type $\vt$ has an empty
