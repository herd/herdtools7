...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      ...
      \item \Prosenonconflictingunion{consisting of $\vsesone$ and $\vsestwo$}{$\vses$}\ProseOrError.
    \end{itemize}
  \end{itemize}
\end{itemize}
\FormallyParagraph
...
\begin{itemize}
  ...
  \item \Prosenonconflictingunion{$\vsesindex$ and $\vsesbase$}{$\vses$}\ProseOrError;
  \item \Proseeqdef{$\newe$}{
...
\begin{itemize}
  ...
  \item \Prosenonconflictingunion{$\vsess$}{$\vses$}\ProseOrError.
\end{itemize}
\FormallyParagraph
\begin{mathpar}
\inferrule{
