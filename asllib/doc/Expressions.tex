...
and \listingref{ESlice-bad2} shows examples of ill-typed bitvector slicing expressions.
...
\ASLListing{Evaluation og tuple expressions}{semantics-etuple}{\semanticstests/SemanticsRule.ETuple.asl}
