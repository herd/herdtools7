...
class ConsoleMacro(BlockMacro):
    ...
    def transform(cls, block_lines: list[str]) -> list[str]:
        ...
        command = (
            ...
            .replace("\\definitiontests", "../compliance/tests/definition")
            .replace("\\syntaxtests", "../compliance/tests/syntax")
            .replace("\\typingtests", "../compliance/tests/typing")
            .replace("\\semanticstests", "../compliance/tests/semantics")
            .replace("\n", "")
            .strip()
        )
