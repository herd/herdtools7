...
def resolve_test_path(test_path: str) -> str:
    test_path_replacements = {
        r"\definitiontests": "../compliance/tests/definition",
        r"\syntaxtests": "../compliance/tests/syntax",
        r"\typingtests": "../compliance/tests/typing",
        r"\semanticstests": "../compliance/tests/semantics",
    }
