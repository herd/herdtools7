...
\checkparamstypesat(
  \overname{\staticenvs}{\tenv} \aslsep
  \overname{\KleeneStar{(\Identifier\times\some{\ty})}}{\funcsigparams} \aslsep
...
\annotateretty(
  ...
  \overname{\some{\ty}}{\funcsigrettyopt} \aslsep
