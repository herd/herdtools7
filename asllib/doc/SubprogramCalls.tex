...
% shows examples of calls to \stdlibfunc{Zeros} and \stdlibfunc{Extend}
% where some of the parameters and/or arguments are omitted,
% and the equivalent calls with the parameters and arguments added.
