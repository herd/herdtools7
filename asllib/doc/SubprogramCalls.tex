...
% This is generated code; run `python3 doclint.py -cm` to update.
\begin{itemize}
  \item \SemanticsRuleRef{Call}
  \item \SemanticsRuleRef{EvalSubprogram}
  \item \SemanticsRuleRef{CheckRecurseLimit}
