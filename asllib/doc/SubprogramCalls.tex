...
\begin{mathpar}
\inferrule[equal]{
  \funcdef.\funcsubprogramtype = \calltype
}{
...
\inferrule[no\_match]{
  ...
  \calltypematches(\func, \calltype) \typearrow \overname{\False}{\vb}
}
\end{mathpar}
...
\[
  \assignargs(
    ...
    \overname{\Identifier^*}{\vids} \aslsep
