...
The function
\[
  \checknoduplicates(\overname{\KleeneStar{\Identifier}}{\id_{1..k}}) \aslto \{\True\} \cup \typeerror
\]
...
The function
\[
  \assocopt(\overname{\KleeneStar{(\Identifier\times T)}}{\vli} \aslsep \overname{\Identifier}{\id}) \typearrow \langle \overname{T}{\vv} \rangle
\]
...
in the \staticenvironmentterm{} $\tenv$, if one exists in $\veopt$ and it is \symbolicallyevaluable\ with
