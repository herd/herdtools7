...
\begin{itemize}
  ...
  \begin{itemize}
    \item $\vbitfields$ starts with a bitfield $\vbf$;
  ...
  \begin{itemize}
    \item $\vbitfields$ starts with a bitfield $\vbf$ and continues with the tail list $\bitfieldsp$;
...
\inferrule[match]{
  ...
  \findbitfieldopt(\name, \overname{\vbf \concat \bitfieldsp}{\vbitfields}) \typearrow \overname{\some{\vbf}}{\vr}
}
\and
\inferrule[tail]{
  \bitfieldgetname(\vbf) \typearrow \namep\\
  ...
  \findbitfieldopt(\name, \overname{\vbf \concat \bitfieldsp}{\vbitfields}) \typearrow \vr
}
\and
\inferrule[empty]{}{
  \findbitfieldopt(\name, \overname{\emptylist}{\vbitfields}) \typearrow \None
}
\end{mathpar}
...
$\ArrayLengthEnum(\vbitsArray, [\vBIG, \vLITTLE])$, and
\[
\begin{array}{r}
\typeofarraylength(\ArrayLengthEnum(\vbitsArray, [\vBIG, \vLITTLE])) \typearrow \\
\TNamed(\vbitsArray) \enspace.
\end{array}
\]
