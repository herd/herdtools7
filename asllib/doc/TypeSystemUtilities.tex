...
\begin{itemize}
  ...
  \item \TypingRuleRef{IsUndefined} checks whether an identifier is undefined in a \staticenvironmentterm{}.
  \item \TypingRuleRef{IsGlobalUndefined} tests whether an identifier is undefined in the \globalstaticenvironmentterm{}.
  \item \TypingRuleRef{IsLocalUndefined} tests whether an identifier is undefined in the \localstaticenvironmentterm{}.
  ...
  \item \TypingRuleRef{LookupImmutableExpr} looks up the initialising expression associated with an immutable storage element.
  \item \TypingRuleRef{AddGlobalImmutableExpr} updates a \globalstaticenvironmentterm{} by associating a global immutable storage element with its initialising expression.
  \item \TypingRuleRef{AddLocalImmutableExpr} updates a \localstaticenvironmentterm{} by associating a local immutable storage element with its initialising expression.
  \item \TypingRuleRef{ShouldRememberImmutableExpression} tests whether to associate an immutable storage element with its initialising expression based on its \sideeffectdescriptorsetsterm.
  \item \TypingRuleRef{AddImmutableExpr} conditionally updates a \staticenvironmentterm{} by associating a local immutable storage element with its initialising expression.
...
\RuleDescription{enables checking for the absence of duplicate elements in a list.}
...
\TypingRuleDef{Sort}
\RuleDescription{allows sorting a list.}
\hypertarget{def-sort}{}
The parametric function
\[
\sort(\overname{\KleeneStar{T}}{\vlone}, \overname{(T, T)\rightarrow \{-1,0,1\}}{\compare}) \aslto \overname{\KleeneStar{T}}{\vltwo}
\]
...
\RuleDescription{recursively looks up a bitfield in a list of bitfields.}
...
\RuleDescription{returns the type associated with an array index.}
...
\RuleDescription{constructs a \staticenvironmentterm{} from a \globalstaticenvironmentterm{}.}
...
\RuleDescription{ensures that a variable is not in the \staticenvironmentterm{}.}
...
\RuleDescription{ensures that a variable is not in the \globalstaticenvironmentterm{}.}
...
\RuleDescription{updates a \staticenvironmentterm{} with a local storage element.}
...
\RuleDescription{checks whether an identifier is undefined in a \staticenvironmentterm{}.}
...
\RuleDescription{tests whether an identifier is undefined in the \globalstaticenvironmentterm{}.}
...
\RuleDescription{tests whether an identifier is undefined in the \localstaticenvironmentterm{}.}
...
\RuleDescription{looks up a \staticenvironmentterm{} for a global constant.}
...
\RuleDescription{updates a \staticenvironmentterm{} for a global storage element.}
...
\RuleDescription{looks up the initialising expression associated with an immutable storage element.}
...
\RuleDescription{updates a \globalstaticenvironmentterm{} by associating a global immutable storage element with its initialising expression.}
...
\RuleDescription{updates a \localstaticenvironmentterm{} by associating a local immutable storage element with its initialising expression.}
...
\RuleDescription{tests whether to associate an immutable storage element with its initialising expression based on its \sideeffectdescriptorsetsterm.}
...
\RuleDescription{conditionally updates a \staticenvironmentterm{} by associating a local immutable storage element with its initialising expression.}
...
\RuleDescription{updates a \staticenvironmentterm{} with a subprogram.}
...
\RuleDescription{updates a \staticenvironmentterm{} with a new type.}
