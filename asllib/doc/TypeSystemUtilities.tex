...
\ChapterOutline
\begin{TypingRuleList}{TypeSystemUtilities}

\TypingRuleDef[checks that a list contains no duplicate elements.]{CheckNoDuplicates}
...
\TypingRuleDef[defines the sorted form of a list.]{Sort}
...
\TypingRuleDef[defines bitfield lookup in a list of bitfields.]{FindBitfieldOpt}
...
\TypingRuleDef[defines array-index type classification.]{TypeOfArrayLength}
...
\TypingRuleDef[constructs a \staticenvironmentterm{} with an empty local environment.]{WithEmptyLocal}
...
\TypingRuleDef[checks for the absence of an identifier binding in a \staticenvironmentterm{}.]{CheckVarNotInEnv}
...
\TypingRuleDef[checks for the absence of an identifier binding in a \globalstaticenvironmentterm{}.]{CheckVarNotInGEnv}
...
\TypingRuleDef[adds a local storage element to a \staticenvironmentterm{}.]{AddLocal}
...
\TypingRuleDef[defines whether an identifier is undefined in a \staticenvironmentterm{}.]{IsUndefined}
...
\TypingRuleDef[defines whether an identifier is undefined in the \globalstaticenvironmentterm{}.]{IsGlobalUndefined}
...
\TypingRuleDef[defines whether an identifier is undefined in the \localstaticenvironmentterm{}.]{IsLocalUndefined}
...
\TypingRuleDef[defines global constant lookup.]{LookupConstant}
...
\TypingRuleDef[associates a global storage element with a constant value.]{AddGlobalConstant}
...
\TypingRuleDef[defines initialising-expression lookup for immutable storage elements.]{LookupImmutableExpr}
...
\TypingRuleDef[records the initialising expression of a global immutable storage element.]{AddGlobalImmutableExpr}
...
\TypingRuleDef[records the initialising expression of a local immutable storage element.]{AddLocalImmutableExpr}
...
\TypingRuleDef[defines when to remember an immutable storage element's initialising expression.]{ShouldRememberImmutableExpression}
...
\TypingRuleDef[conditionally records the initialising expression of an immutable storage element.]{AddImmutableExpr}
...
\TypingRuleDef[adds a subprogram to a \staticenvironmentterm{}.]{AddSubprogram}
...
\TypingRuleDef[adds a type to a \staticenvironmentterm{}.]{AddType}
