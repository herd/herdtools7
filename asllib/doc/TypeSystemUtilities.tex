...
\ChapterOutline
\begin{itemize}
  \item \TypingRuleRef{NoDuplicates} tests whether a list does not contain duplicate elements;
...
\TypingRuleDef{NoDuplicates}
\RenderRelation{no_duplicates}
...
\RenderProseAndFormally{no_duplicates}
