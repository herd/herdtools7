...
The function
\[
  \assocopt(\overname{\KleeneStar{(\Identifier\times T)}}{\vli} \aslsep \overname{\Identifier}{\id}) \typearrow \some{\overname{T}{\vv}}
\]
...
\addimmutableexpression(
  ...
  \overname{\some{(\overname{\expr}{\ve}\times\overname{\TSideEffectSet}{\vsese})}}{\veopt} \aslsep
  \overname{\Identifier}{\vx}) \\
