...
\begin{itemize}
  ...
  \item \TypingRuleRef{AddGlobalImmutableExpr} updates a \globalstaticenvironmentterm{} by associating a global immutable storage element
        with its initialising expressions.
  ...
  \item \TypingRuleRef{ShouldRememberImmutableExpression} tests whether to associate an immutable storage element
        with its initialising expressions based on its \sideeffectdescriptorsetsterm.
  \item \TypingRuleRef{AddImmutableExpr} conditionally updates a \staticenvironmentterm{} by associating
        a local immutable storage element with its initialising expressions.
