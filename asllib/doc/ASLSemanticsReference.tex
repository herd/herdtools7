...
\subsection{SemanticsRule.SReturnNone \label{sec:SemanticsRule.SReturnNone}}
    ...
    The program:
    \VerbatimInput{../tests/ASLSemanticsReference.t/SemanticsRule.SReturnNoneReturn.asl} 
    exits the current procedure.

    \subsubsection{Example: SReturnNonePrint.asl}
    The program:
    \VerbatimInput{../tests/ASLSemanticsReference.t/SemanticsRule.SReturnNonePrint.asl}
    prints "012".
