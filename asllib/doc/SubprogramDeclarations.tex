...
\hypertarget{def-checksubprogrampurity}{}
The function
\[
...
\begin{itemize}
  ...
  \item the side effects of the body of \verb|bar| are all \readonly{}; and
...
\begin{mathpar}
\inferrule[none]{}{
  \checksubprogrampurity(\overname{\None}{\vqualifier}) \typearrow \overname{\True}{\vb}
}
\end{mathpar}
