...
\Nfuncargs          \derives \ & \Tlpar \parsesep \Clist{\Ntypedidentifier} \parsesep \Trpar &\\
...
\inferrule{
  ...
  \checktrans{\paramsone = \funcsig.\funcparameters}{\BadParameterDecl} \checktransarrow \vb \OrTypeError
}{
...
with respect to $\tenv$ and then declares the parameter $\vx$ in environment $\newtenv$.
The result is the updated environment $\newtenvp$, annotated argument type $\ttyp$, and
...
\item The function $\stringofnat : \N \rightarrow \Strings$ converts a natural number
