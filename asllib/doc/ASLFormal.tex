...
\begin{itemize}
  ...
  \item \secref{Inference Rules} defines the concept of inference rules;
  ...
  \item \secref{ConventionallyUsedJudgments} presents conventionally-used judgments and notations; and
