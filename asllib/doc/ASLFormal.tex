...
The parametric function $\listrange(\KleeneStar{T}) \aslto \KleeneStar{\N}$ returns the ($1$-based) list of indices for a given list:
\[
    \begin{array}{rcl}
...
\[
\intersectionlist(\KleeneStar{\pow{T}}) \aslto \pow{T}
\]
