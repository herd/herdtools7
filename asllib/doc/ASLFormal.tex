...
Similarly, if the first transition judgment results in a \ErrorConfigurationTerm, the output configuration of
the conclusion is \ErrorConfigurationTerm, which corresponds to the following rule in the expansion:
\begin{mathpar}
\inferrule{\op \not\in \{\BAND, \BOR, \IMPL\}\\\\
