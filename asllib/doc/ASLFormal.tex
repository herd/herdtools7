...
The domain of a \configurationterm{} $C=L(\ldots)$, denoted $\configdomain{C}$, is the label $L$.
...
while the output \configurationterm{} does not have a \configurationterm{} domain, since it is an unlabelled tuple.
