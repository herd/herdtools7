...
and the rule \TypingRuleRef{Binop} (somewhat simplified here) has three premises:
\begin{mathpar}
\inferrule{
...
%
For example, the rule \TypingRuleRef{Binop} applies to any choice of values for the free variables
...
\end{definition}
For example,
the following is a grounding of \TypingRuleRef{Binop}
\begin{mathpar}
\inferrule{
