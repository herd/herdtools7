...
\begin{itemize}
\item $\N$ is the set of natural numbers, including $0$.
...
\hypertarget{operator-land}{}\hypertarget{operator-lor}{}%
...
\item $\Strings$ is the set of all ASCII strings.
...
\begin{definition}[Function Update\label{def:FunctionUpdate}]
  ...
  \texthypertarget{relation-bindings}
  and $\bindings{f}$ returns the list of input-output pairs of $f$ in an arbitrary order.
\end{definition}
...
\]
lists the pairs of input-output values for a given partial function f:
\[
...
\hypertarget{operator-stringofnat}{}
