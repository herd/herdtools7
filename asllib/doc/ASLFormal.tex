...
\begin{description}
  ...
  of compound values, we write $v \eqname \textit{f}(u_{1..k})$ where the expression on the right-hand side exposes the internal structure of $v$ by introducing the variables
