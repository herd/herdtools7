...
parameterized by the type of its arguments. An example is the $\equallength$ function where the
...
Judgments of the form $R(a_1,\ldots,a_n) \longrightarrow r$ are used to uniformly denote
both function applications and relation applications, where $R$ is either a function or a relation.
When $R$ is a function, the judgment $R(a_1,\ldots,a_n) \longrightarrow r$ stands for $R(a_1,\ldots,a_n) = r$ and
when $R$ is a relation, the judgment stands for $((a_1,\ldots,a_n), r) \in R$.
...
%
For example, if the first transition judgment results in a throwing \configurationterm{} $\ThrowingConfig$
