...
\begin{description}
  ...
  \item[$\BinopPriority$]
    ...
    A compound \binopexpressionterm{} consisting of two associative binary operators of the same priority was used without sufficient parentheses.
...
\item[$\BadField$]
  ...
  For example:
  \begin{itemize}
    \item An initialization expression for a \structuredtypeterm{} is missing a field (\TypingRuleRef{ERecord}).
