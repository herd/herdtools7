...
\aslto \overname{\some{\intconstraint}}{\vcopt}
\]
...
\refineconstraints\left(
  ...
  \overname{\{\Over,\Under\}}{\vapprox} \aslsep\\
  \overname{\staticenvs}{\tenv} \aslsep\\
  \overname{\intconstraint\rightarrow\some{\intconstraint}}{\vf} \aslsep\\
  \overname{\KleeneStar{\intconstraint}}{\cs}
  \end{array}
  \right)
\aslto
...
\filterreduceconstraintdiv(
  ...
  \overname{\some{\intconstraint}}{\vcopt}
\]
...
The function
\[
\getliteraldivopt(\overname{\expr}{\ve}) \aslto \overname{\some{(\Z\cartimes\Z)}}{\rangeopt}
\]
