...
\inferrule[div\_non\_empty]{
  ...
  \vres \eqdef \concatlist{\vi\in\listrange(\cs): \ifthenelseop[H]{\vcopt_\vi = \some{\vcp_\vi}}{[\vcp]}{\emptylist}}\\
  \vres \neq \emptylist
}{
...
\inferrule[div\_empty]{
  ...
  \refineconstraintfordiv(\vapprox, \op, \cs) \typearrow \ifthenelseop[H]{\vapprox=\Over}{\CannotOverapproximate}{\CannotUnderapproximate}
}
\end{mathpar}
