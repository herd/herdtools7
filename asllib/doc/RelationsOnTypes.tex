...
\inferrule[otherwise1]{
  ...
  \isanonymous(\tenv, \vs) \typearrow \vbtwo\hva\\
  \subtypesatisfies(\tenv, \vt, \vs) \typearrow \vbthree\\
  \neg((\vbone \lor \vbtwo) \land \vbthree)\hva\hva\\
...
\inferrule[range\_both\_reduce\_to\_z]{
  ...
  \vzeroorone \eqdef \choice{\vp(0)}{\ELInt{0}}{\ELInt{1}}\hva\\
  \vzeroorminusone \eqdef \choice{\vp(0)}{\ELInt{0}}{\ELInt{-1}}\\
...
\inferrule[only\_e1\_reduces\_to\_z]{
  ...
  \vzeroorone \eqdef \choice{\vp(0)}{\ELInt{0}}{\ELInt{1}}\\
...
\inferrule[only\_e2\_reduces\_to\_z]{
  ...
  \reducetozopt(\tenv, \vetwo) \typearrow \some{\vztwo}\\
  \vzeroorminusone \eqdef \choice{\vp(0)}{\ELInt{0}}{\ELInt{-1}}\hva\\
  \vrangezeroorminusone \eqdef \ConstraintRange(\veone, \vzeroorminusone)\\
  {
  \vcopt \eqdef \begin{cases}
...
\inferrule[div\_non\_empty]{
  ...
  \vres \eqdef \concatlist{\vi\in\listrange(\cs): \choice{\vcopt_\vi = \some{\vcp_\vi}}{[\vcp]}{\emptylist}}\\
  \vres \neq \emptylist
}{
