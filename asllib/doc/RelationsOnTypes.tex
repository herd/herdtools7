...
\]
returns $\None$ if $\vc$ is an exact constraint for a b\binopexpressionterm{} for dividing two integer literals
...
\end{array}
\]
given the static environment $\tenv$ and the constraint $\vc$,
