...
%
%\begin{comment}
%ROMAN: since all forms of slice are syntactic sugar for the \texttt{+:} range slice, why do we need the AST to have all other forms of slices?
%\end{comment}
%
%
...
%
%\begin{verbatim}
%func bits_match{N}(x: bits(N), definite_mask: bits(N), any_mask: bits(N));
%\end{verbatim}
