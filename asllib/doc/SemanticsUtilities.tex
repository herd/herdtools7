...
The relation
\[
  \slicestopositions(\overname{\KleenePlus{(\overname{\tint}{\vs_i}\times\overname{\tint}{\vl_i})}}{\slices}) \;\aslrel\;
  (\overname{\KleeneStar{\N}}{\positions} \cup\ \overname{\TDynError}{\BadIndex})
\]
...
The relation
\[
  \readfrombitvector(\overname{\Nvalue}{\vv} \aslsep \overname{\KleeneStar{(\tint\times\tint)}}{\slices}) \;\aslrel\;
