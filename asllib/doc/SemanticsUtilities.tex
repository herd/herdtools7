...
\begin{SemanticsRuleList}{SemanticsUtilities}

\SemanticsRuleDef[retrieves the $\pendingcalls$ value from an environment.]{GetPendingCalls}
...
\SemanticsRuleDef[updates the $\pendingcalls$ value in an environment.]{SetPendingCalls}
...
\SemanticsRuleDef[increments the $\pendingcalls$ value in an environment by one.]{IncrPendingCalls}
...
\SemanticsRuleDef[decrements the $\pendingcalls$ value in an environment by one.]{DecrPendingCalls}
...
\SemanticsRuleDef[removes a local storage element from a \dynamicenvironmentterm{}.]{RemoveLocal}
...
\SemanticsRuleDef[constructs an \executiongraphterm{} for reading an identifier.]{ReadIdentifier}
...
\SemanticsRuleDef[constructs an \executiongraphterm{} for writing an identifier.]{WriteIdentifier}
...
\SemanticsRuleDef[concatenates a list of bitvector \nativevaluesterm{}.]{ConcatBitvectors}
...
\SemanticsRuleDef[converts a list of slices into a list of indices.]{SlicesToPositions}
...
\SemanticsRuleDef[finds the maximum position in a slice.]{MaxPosOfSlice}
...
\SemanticsRuleDef[slices a bitvector \nativevalueterm{}.]{ReadFromBitvector}
...
\SemanticsRuleDef[updates a slice of a bitvector \nativevalueterm{}.]{WriteToBitvector}
...
\SemanticsRuleDef[reads a vector \nativevalueterm{} at an index.]{GetIndex}
...
\SemanticsRuleDef[updates a vector \nativevalueterm{} at an index.]{SetIndex}
...
\SemanticsRuleDef[reads a field in a \nativevalueterm{} record.]{GetField}
...
\SemanticsRuleDef[updates a field in a \nativevalueterm{} record.]{SetField}
...
\SemanticsRuleDef[declares a local identifier in an environment and records a write effect.]{DeclareLocalIdentifier}
...
\SemanticsRuleDef[declares a local identifier and records a write effect with an $\asldata$ edge.]{DeclareLocalIdentifierM}
...
\SemanticsRuleDef[declares a local identifier and records a write effect with an $\aslpo$ edge.]{DeclareLocalIdentifierMM}
