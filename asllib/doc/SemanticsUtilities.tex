...
% SEMANTICS_RULES_BEGIN
% This is generated code; run `python3 doclint.py -cm` to update.
\begin{itemize}
  \item \SemanticsRuleRef{GetPendingCalls} retrieves the $\pendingcalls$ value from an environment.
  \item \SemanticsRuleRef{SetPendingCalls} updates the $\pendingcalls$ value in an environment.
  \item \SemanticsRuleRef{IncrPendingCalls} increments the $\pendingcalls$ value in an environment by one.
  \item \SemanticsRuleRef{DecrPendingCalls} decrements the $\pendingcalls$ value in an environment by one.
  ...
  \item \SemanticsRuleRef{DeclareLocalIdentifier} updates an environment by associating an identifier with a given \nativevalueterm{} and also generates an \executiongraphterm{} with a corresponding Write Effect.
  \item \SemanticsRuleRef{DeclareLocalIdentifierM} updates an environment by associating an identifier with a given \nativevalueterm{} and also updates a given \executiongraphterm{} with a corresponding Write Effect and an $\asldata$ edge.
  \item \SemanticsRuleRef{DeclareLocalIdentifierMM} updates an environment by associating an identifier with a given \nativevalueterm{} and also updates a given \executiongraphterm{} with a corresponding Write Effect and an $\aslpo$ edge.
\end{itemize}
% SEMANTICS_RULES_END

\SemanticsRuleDef{GetPendingCalls}
\RuleDescription{retrieves the $\pendingcalls$ value from an environment.}
...
\RuleDescription{updates the $\pendingcalls$ value in an environment.}
...
\RuleDescription{increments the $\pendingcalls$ value in an environment by one.}
...
\RuleDescription{decrements the $\pendingcalls$ value in an environment by one.}
...
\RuleDescription{removes a local storage element from a given environment.}
...
\RuleDescription{creates an \executiongraphterm{} representing a Read Effect for a given identifier.}
...
\RuleDescription{creates an \executiongraphterm{} representing a Write Effect for a given identifier.}
...
\RuleDescription{concatenates a list of bitvector \nativevaluesterm{}.}
...
\RuleDescription{converts a list of slices into a list of indices.}
...
\RuleDescription{finds the maximum position in a slice.}
...
\RuleDescription{slices a bitvector \nativevalueterm{}.}
...
\RuleDescription{updates a slice of a bitvector \nativevalueterm{}.}
...
\RuleDescription{reads a vector \nativevalueterm{} at a given index.}
...
\RuleDescription{updates a vector \nativevalueterm{} at a given index.}
...
\RuleDescription{reads a given field in a \nativevalueterm{} record.}
...
\RuleDescription{updates a given field in a \nativevalueterm{} record.}
...
\RuleDescription{updates an environment by associating an identifier with a given \nativevalueterm{} and also generates an \executiongraphterm{} with a corresponding Write Effect.}
