...
The specifications in \listingref{typing-sdecl-bad1} and \listingref{typing-sdecl-bad2}
are ill-typed, since constant storage elements and immutable local storage elements
require an initializing expression.
\ASLListing{An uninitialized constant declaration}{typing-sdecl-bad1}{\typingtests/TypingRule.SDecl.bad1.asl}
