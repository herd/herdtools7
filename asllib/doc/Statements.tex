...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item the result is a \ErrorConfigurationTerm{}.
  \end{itemize}
\end{itemize}
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      ...
      \item the result is a \ErrorConfigurationTerm{} indicating the assertion failure returned (\DynamicAssertionFailure).
    \end{itemize}
  \end{itemize}
\end{itemize}
...
If the value is $0$, the result is a \ErrorConfigurationTerm{}.
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item the result is a \ErrorConfigurationTerm{} indicating that a limit has been reached
  \end{itemize}
\end{itemize}
...
\ProseParagraph
Evaluating $\SUnreachable$ in an environment $\env$ results in a \ErrorConfigurationTerm{} indicating this ($\UnreachableError$).
\FormallyParagraph
\begin{mathpar}
\inferrule{}{
