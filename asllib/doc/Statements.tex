...
\ASLListing{}{semantics-}{\semanticstests/SemanticsRule.SPass.asl}
...
\subsubsection{Example}
In the specification:
\ASLListing{}{semantics-}{\semanticstests/SemanticsRule.SAssign.asl}
...
The specification:
\ASLListing{}{semantics-}{\semanticstests/SemanticsRule.SDeclSome.asl}
...
In the specification:
\ASLListing{}{semantics-}{\semanticstests/SemanticsRule.SDeclNone.asl}
...
\subsubsection{Example}
In the specification:
\ASLListing{}{semantics-}{\semanticstests/SemanticsRule.SSeq.asl}
...
\subsubsection{Example}
In the specification:
\ASLListing{}{semantics-}{\semanticstests/SemanticsRule.SCall.asl}
...
The specification:
\ASLListing{}{semantics-}{\semanticstests/SemanticsRule.SCond.asl}
does not result in any Assertion Error.

The specification:
\ASLListing{}{semantics-}{\semanticstests/SemanticsRule.SCond2.asl}
does not result in any error.

The specification:
\ASLListing{}{semantics-}{\semanticstests/SemanticsRule.SCond3.asl}
results in an Assertion Error.

The specification:
\ASLListing{}{semantics-}{\semanticstests/SemanticsRule.SCond4.asl}
does not result in any error.
...
\subsubsection{Example}
In the specification:
\ASLListing{}{semantics-}{\semanticstests/SemanticsRule.SAssertOk.asl}
\texttt{assert (42 != 3);} ensures that \texttt{3} is not equal to \texttt{42}.

\subsubsection{Example}
In the specification:
\ASLListing{}{semantics-}{\semanticstests/SemanticsRule.SAssertNo.asl}
...
\subsubsection{Example}
The specification:
\ASLListing{}{semantics-}{\semanticstests/SemanticsRule.SWhile.asl}
prints \texttt{0123}.
...
\subsubsection{Example}
The specification:
\ASLListing{}{semantics-}{\semanticstests/SemanticsRule.Loop.asl}
...
\subsubsection{Example}
The specification:
\ASLListing{}{semantics-}{\semanticstests/SemanticsRule.SRepeat.asl}
prints
\begin{Verbatim}
  0
  1
...
\subsubsection{Example}
The specification:
\ASLListing{}{semantics-}{\semanticstests/SemanticsRule.SFor.asl}
prints
\begin{Verbatim}
  0
  1
...
\subsubsection{Example}
The specification:
\ASLListing{}{semantics-}{\semanticstests/SemanticsRule.For.asl}
...
The specification:
\ASLListing{}{semantics-}{\semanticstests/SemanticsRule.SThrowNone.asl}
throws a \texttt{MyException} exception.

\subsubsection{Example (Throwing a Typed Exception)}
The specification:
\ASLListing{}{semantics-}{\semanticstests/SemanticsRule.SThrowSomeTyped.asl}
...
\subsubsection{Example}
The specification:
\ASLListing{}{semantics-}{\semanticstests/SemanticsRule.STry.asl}
...
The specification:
\ASLListing{}{semantics-}{\semanticstests/SemanticsRule.SReturnNone.asl}
exits the current procedure.

\subsubsection{Example (Returning a Single Value)}
In the specification:
\ASLListing{}{semantics-}{\semanticstests/SemanticsRule.SReturnOne.asl}
\texttt{return 3;} exits the current subprogram with value \texttt{3}.

\subsubsection{Example (Returning Multiple Values)}
In the specification:
\ASLListing{}{semantics-}{\semanticstests/SemanticsRule.SReturnSome.asl}
