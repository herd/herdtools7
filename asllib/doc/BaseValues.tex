...
Each type have a \basevalueterm, which is used
to initialize storage elements (either local of global),
if an initializer is not supplied.
%
The exception are \parameterizedintegertypes{} and \bitvectortypesterm{}
whose length depends on a \parameterizedintegertype{}.
...
\subsubsection{Example: No Base Value for Parameterized Integer Types}
...
\ASLListing{Ill-typed Base Value}{base-values-bad}{\typingtests/TypingRule.BaseValue.bad.asl}
