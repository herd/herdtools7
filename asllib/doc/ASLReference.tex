...
\newcommand\VERSION[0]{ASLRefEAC2}
\emergencystretch=2em % reduces overfull boxes with minimal visual change.
\raggedbottom
\input{ASLmacros}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\definitiontests}{../compliance/tests/definition/}
\newcommand{\syntaxtests}{../compliance/tests/syntax/}
\newcommand{\typingtests}{../compliance/tests/typing/}
\newcommand{\semanticstests}{../compliance/tests/semantics/}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
