...
\subsubsection{TypingRule.Normalize \label{sec:TypingRule.Normalize}}
...
\subsubsection{TypingRule.ReduceConstraint \label{sec:TypingRule.ReduceConstraint}}
...
\subsubsection{TypingRule.ReduceConstraints \label{sec:TypingRule.ReduceConstraints}}
...
\subsubsection{TypingRule.ToIR \label{sec:TypingRule.ToIR}}
...
\subsubsection{TypingRule.ExprEqual \label{sec:TypingRule.ExprEqual}}
...
\subsubsection{TypingRule.ExprEqualNorm \label{sec:TypingRule.ExprEqualNorm}}
...
\subsubsection{TypingRule.ExprEqualCase \label{sec:TypingRule.ExprEqualCase}}
...
\subsubsection{TypingRule.TypeEqual \label{sec:TypingRule.TypeEqual}}
...
\subsubsection{TypingRule.BitwidthEqual \label{sec:TypingRule.BitwidthEqual}}
...
\subsubsection{TypingRule.BitFieldsEqual \label{sec:TypingRule.BitFieldsEqual}}
...
\subsubsection{TypingRule.BitFieldEqual \label{sec:TypingRule.BitFieldEqual}}
The function
\[
...
\subsubsection{TypingRule.ConstraintsEqual \label{sec:TypingRule.ConstraintsEqual}}
...
\subsubsection{TypingRule.ConstraintEqual \label{sec:TypingRule.ConstraintEqual}}
...
\subsubsection{TypingRule.SlicesEqual \label{sec:TypingRule.SlicesEqual}}
...
\subsubsection{TypingRule.SliceEqual \label{sec:TypingRule.SliceEqual}}
...
\subsubsection{TypingRule.ArrayLengthEqual \label{sec:TypingRule.ArrayLengthEqual}}
...
\subsubsection{TypingRule.LiteralEqual \label{sec:TypingRule.LiteralEqual}}
...
\subsubsection{TypingRule.ReduceIR \label{sec:TypingRule.ReduceIR}}
...
\subsubsection{Prose}
\subsubsection{Formally}
\subsubsection{TypingRule.PolynomialToExpr \label{sec:TypingRule.PolynomialToExpr}}
...
\subsubsection{TypingRule.CompareMonomialBindings \label{sec:TypingRule.CompareMonomialBindings}}
...
\subsubsection{TypingRule.MonomialsToExpr \label{sec:TypingRule.MonomialsToExpr}}
...
\subsubsection{TypingRule.MonomialToExpr \label{sec:TypingRule.MonomialToExpr}}
...
\subsubsection{TypingRule.SymAddExpr \label{sec:TypingRule.SymAddExpr}}
...
\subsubsection{TypingRule.UnitaryMonomialsToExpr \label{sec:TypingRule.UnitaryMonomialsToExpr}}
...
\subsubsection{TypingRule.SymMulExpr \label{sec:TypingRule.SymMulExpr}}
...
\subsubsection{TypingRule.NormalizeOpt\label{sec:TypingRule.NormalizeOpt}}
