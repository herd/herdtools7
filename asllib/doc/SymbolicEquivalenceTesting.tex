...
We say that $\veone$ and $\vetwo$ are \emph{\equivalentexprsterm{}} in the static environment $\tenv$
...
We say that $\vt$ and $\vs$ are \emph{\equivalenttypesterm{}} in the static environment $\tenv$
...
We say that $\vcone$ and $\vctwo$ are \emph{\equivalentconstraintsterm{}} in the static environment $\tenv$
if for every dynamic environment $\denv$
and environment $\env = (\tenv, \denv)$, the following condition holds:
\[
...
\]
conservatively checks whether $\veone$ and $\vetwo$ are \equivalentexprsterm{} in environment $\tenv$.
...
\]
conservatively tests whether the $\veone$ and $\vetwo$ are \equivalentexprsterm{} in the static environment $\tenv$
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item testing whether $\veoneone$ and $\vetwoone$ are \equivalentexprsterm{} yields $\vbone$\ProseOrTypeError;
    \item testing whether $\veonetwo$ and $\vetwotwo$ are \equivalentexprsterm{} yields $\vbtwo$\ProseOrTypeError;
    \item testing whether $\veonethree$ and $\vetwothree$ are \equivalentexprsterm{} yields $\vbthree$\ProseOrTypeError;
...
\[
  \typeequal(\overname{\staticenvs}{\tenv} \aslsep \overname{\ty}{\vtone} \aslsep \overname{\ty}{\vttwo}) \aslto
   \overname{\Bool}{\vb} \cup \overname{\TTypeError}{\TypeErrorConfig}
\]
conservatively tests whether $\vtone$ and $\vttwo$ are \equivalenttypesterm{} in environment $\tenv$
