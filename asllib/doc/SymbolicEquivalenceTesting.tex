...
\inferrule[e\_call]{
  \veone = \ECall(\nameone, \vargsone, \Ignore)\\
  \vetwo = \ECall(\nametwo, \vargstwo, \Ignore)\hva\\\\
  \booltrans(\nameone = \nametwo) \booltransarrow \True \terminateas \False\hva\\\\
  \equallength(\vargsone, \vargstwo) \typearrow \True \terminateas \False\hva\\\\
  i \in \listrange(\vargsone): \exprequal(\tenv, \vargsone[i], \vargstwo[i]) \typearrow \vb_i \OrTypeError\hva\\\\
...
\inferrule[e\_tuple]{
  \veone = \ETuple(\vlone)\\
  \vetwo = \ETuple(\vltwo)\\
  \equallength(\vlone, \vltwo) \typearrow \True \terminateas \False\hva\\\\
  i \in \listrange(\vlone): \exprequal(\tenv, \vlone[i], \vltwo[i]) \typearrow \vb_i \OrTypeError\hva\\\\
...
\inferrule[ttuple]{
  ...
  i \in \listrange(\vtsone): \typeequal(\tenv, \vtsone[i], \vtstwo[i]) \typearrow \vb_i \OrTypeError\hva\\\\
...
\inferrule[same\_lengths]{
  ...
  i\in\listrange(\bfone): \bitfieldequal(\tenv, \bfone[i], \bftwo[i]) \typearrow \vb_i\hva\\\\
...
\inferrule{
  ...
  i\in\listrange(\csone): \constraintequal(\tenv, \csone[i], \cstwo[i]) \typearrow \vb_i \OrTypeError\hva\\\\
...
\inferrule[same\_lengths]{
  ...
  i\in\listrange(\slicesone): \sliceequal(\tenv, \slicesone[i], \slicestwo[i]) \typearrow \vb_i \OrTypeError\hva\\\\
...
\inferrule[non\_empty]{
  ...
  \monomsandfactorslist \eqdef \listset(\monomsandfactors)\hva\\
