...
\begin{itemize}
  ...
  \begin{itemize}
    \item $\ve$ is a \binopexpressionterm{} with an operator $\op$ that is other than $\PLUS$, $\MINUS$, $\MUL$, or $\SHL$,
  ...
  \begin{itemize}
    \item $\ve$ is a \binopexpressionterm{} with an operator $\op$ that is other than $\PLUS$, $\MINUS$, $\MUL$, $\DIV$, or $\SHL$,
          applied to the operand expressions $\veone$ and $\vetwo$;
