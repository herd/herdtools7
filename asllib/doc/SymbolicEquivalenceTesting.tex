...
\ChapterOutline
\begin{itemize}
  \item \secref{symbolicexpressions} defines symbolic expressions and operations over symbolic expressions; and
...
These symbolic expressions provide a canonical representation for multivariate polynomials
