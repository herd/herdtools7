...
\begin{itemize}
  ...
  \item \TypingRuleRef{PatternEqual}
  ...
  \item \TypingRuleRef{PolynomialToExpr}
  \item \TypingRuleRef{CompareMonomialBindings}
  \item \TypingRuleRef{MonomialsToExpr}
  \item \TypingRuleRef{MonomialToExpr}
  \item \TypingRuleRef{SymAddExpr}
  \item \TypingRuleRef{UnitaryMonomialsToExpr}
  \item \TypingRuleRef{SymMulExpr}
  \item \TypingRuleRef{TypeOf}
  \item \TypingRuleRef{NormalizeOpt}
\end{itemize}
% TYPING_RULES_END
