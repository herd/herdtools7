...
\TypingRuleDef[checks symbolic equivalence between lists of patterns and their kinds.]{PatternListAndKindEqual}
\RenderRelation{pattern_list_and_kind_equal}

See \ExampleRef{Expression Equivalence}.

\RenderProseAndFormally{pattern_list_and_kind_equal}
...
\TypingRuleDef[checks symbolic equivalence between array length expressions.]{ArrayLengthEqual}
