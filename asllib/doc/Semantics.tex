...
% BEGIN_GENERATED_ELEMENT(native_value)
\hypertarget{type-nativevalue}{}\hypertarget{type-NVLiteral}{}
\begin{flalign*}
\nativevalue \triangleq\ & \NVLiteral(\overtext{\literal}{l})\hypertarget{type-NVVector}{}\\
\cup\ & \NVVector(\overtext{\KleeneStar{\nativevalue}}{values})\hypertarget{type-NVRecord}{}\\
\cup\ & \NVRecord(\overtext{\Identifier \partialto \nativevalue}{field to value})
\end{flalign*}
...
% BEGIN_GENERATED_ELEMENT(tint, tbool, treal, tlabel, tstring, tbitvector, tvector, trecord)
\hypertarget{type-tint}{}
\begin{flalign*}
\tint \triangleq\ & \NVLiteral(\LInt(\overtext{\Z}{v}))
\hypertarget{type-tbool}{}
\\
\tbool \triangleq\ & \NVLiteral(\LBool(\overtext{\Bool}{v}))
\hypertarget{type-treal}{}
\\
\treal \triangleq\ & \NVLiteral(\LReal(\overtext{\Q}{v}))
\hypertarget{type-tlabel}{}
\\
\tlabel \triangleq\ & \NVLiteral(\LLabel(\overtext{\Identifier}{v}))
\hypertarget{type-tstring}{}
\\
\tstring \triangleq\ & \NVLiteral(\LString(\overtext{\Strings}{v}))
\hypertarget{type-tbitvector}{}
\\
\tbitvector \triangleq\ & \NVLiteral(\LBitvector(\overtext{\KleeneStar{\Bit}}{v}))
\hypertarget{type-tvector}{}
\\
\tvector \triangleq\ & \NVVector(\overtext{\KleeneStar{\nativevalue}}{values})
\hypertarget{type-trecord}{}
\\
\trecord \triangleq\ & \NVRecord(\overtext{\Identifier \partialto \nativevalue}{field to value})
\end{flalign*}
% END_GENERATED_ELEMENT
...
% BEGIN_GENERATED_ELEMENT(dynamic_envs, global_dynamic_envs, local_dynamic_envs)
\hypertarget{type-dynamicenvs}{}
\begin{flalign*}
\dynamicenvs \triangleq\ & (\overtext{\globaldynamicenvs}{G}, \overtext{\localdynamicenvs}{L})
\hypertarget{type-globaldynamicenvs}{}
\\
\globaldynamicenvs \triangleq\ & \left\{\begin{array}{lll}
\text{storage} &:& \Identifier \partialto \nativevalue\\
\text{pending\_calls} &:& \Identifier \partialto \N
\end{array}\right\}
...
% BEGIN_GENERATED_ELEMENT(envs)
\hypertarget{type-envs}{}
\begin{flalign*}
\envs \triangleq\ & (\overtext{\staticenvs}{static}, \overtext{\dynamicenvs}{dynamic})
\end{flalign*}
% END_GENERATED_ELEMENT
...
% BEGIN_GENERATED_ELEMENT(XGraphs, Nodes, Labels)
\hypertarget{type-XGraphs}{}
\begin{flalign*}
\XGraphs \triangleq\ & (\overtext{\pow{\Nodes}}{vertices}, \overtext{\pow{(\overtext{\Nodes}{source}, \overtext{\Labels}{label}, \overtext{\Nodes}{target})}}{edges}, \overtext{\pow{\Nodes}}{output nodes})
\hypertarget{type-Nodes}{}
\\
\Nodes \triangleq\ & (\overtext{\N}{node id}, \overtext{\{\Read, \Write\}}{effect type}, \overtext{\Identifier}{storage element})
...
% BEGIN_GENERATED_ELEMENT(TNormal)
\hypertarget{type-TNormal}{}\hypertarget{type-ResultExpr}{}
\begin{flalign*}
\TNormal \triangleq\ & \ResultExpr(\overtext{(\nativevalue, \XGraphs)}{value and graph}, \overtext{\envs}{environment})\hypertarget{type-ResultExprSEF}{}\\
\cup\ & \ResultExprSEF(\overtext{\nativevalue}{value}, \overtext{\XGraphs}{graph})\hypertarget{type-ResultLexpr}{}\\
\cup\ & \ResultLexpr(\overtext{\XGraphs}{graph}, \overtext{\envs}{environment})\hypertarget{type-ResultLDI}{}\\
\cup\ & \ResultLDI(\overtext{\XGraphs}{graph}, \overtext{\envs}{environment})\hypertarget{type-ResultSlices}{}\\
\cup\ & \ResultSlices(\overtext{(\KleeneStar{(\nativevalue, \nativevalue)}, \XGraphs)}{slices and graph}, \overtext{\envs}{environment})\hypertarget{type-ResultExprList}{}\\
\cup\ & \ResultExprList(\overtext{(\KleeneStar{\nativevalue}, \XGraphs)}{values and graph}, \overtext{\envs}{environment})\hypertarget{type-ResultExprListM}{}\\
\cup\ & \ResultExprListM(\overtext{\KleeneStar{(\nativevalue, \XGraphs)}}{value graph pairs}, \overtext{\envs}{environment})\hypertarget{type-ResultPattern}{}\\
\cup\ & \ResultPattern(\overtext{\tbool}{boolean value}, \overtext{\XGraphs}{graph})\hypertarget{type-ResultCall}{}\\
\cup\ & \ResultCall(\overtext{\KleeneStar{(\nativevalue, \XGraphs)}}{value graph pairs}, \overtext{\envs}{environment})
\end{flalign*}
% END_GENERATED_ELEMENT

  \item[Exceptions.] Semantic configurations in
% BEGIN_GENERATED_ELEMENT(TThrowing)
\hypertarget{type-TThrowing}{}\hypertarget{type-Throwing}{}
\begin{flalign*}
\TThrowing \triangleq\ & \Throwing(\overtext{\nativevalue}{exception value}, \overtext{\ty}{exception type}, \overtext{\XGraphs}{graph}, \overtext{\envs}{environment})
\end{flalign*}
% END_GENERATED_ELEMENT
...
% BEGIN_GENERATED_ELEMENT(TReturning)
\hypertarget{type-TReturning}{}\hypertarget{type-Returning}{}
\begin{flalign*}
\TReturning \triangleq\ & \Returning(\overtext{(\KleeneStar{\nativevalue}, \XGraphs)}{values and graph}, \overtext{\envs}{environment})
\end{flalign*}
% END_GENERATED_ELEMENT
...
% BEGIN_GENERATED_ELEMENT(TContinuing)
\hypertarget{type-TContinuing}{}\hypertarget{type-Continuing}{}
\begin{flalign*}
\TContinuing \triangleq\ & \Continuing(\overtext{\XGraphs}{graph}, \overtext{\envs}{environment})
\end{flalign*}
% END_GENERATED_ELEMENT
...
% BEGIN_GENERATED_ELEMENT(TDynError)
\hypertarget{type-TDynError}{}\hypertarget{type-DynamicError}{}
\begin{flalign*}
\TDynError \triangleq\ & \DynamicError(\overtext{\Strings}{error code})
\end{flalign*}
% END_GENERATED_ELEMENT
...
% BEGIN_GENERATED_ELEMENT(Diverging)
\hypertarget{constant-Diverging}{} $\Diverging$
% END_GENERATED_ELEMENT
The corresponding type is:
% BEGIN_GENERATED_ELEMENT(TDiverging)
...
\inferrule*[right=\ref{sec:SemanticsRule.Binop}]{
  ...
  \inferrule*[right=\ref{sec:SemanticsRule.BinopValues}]{}{\binoprel(\ADD, \nvint(1), \nvint(2)) \evalarrow \nvint(3)}
}{
