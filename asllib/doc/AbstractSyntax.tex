...
$\AbbrevEBinop{\op}{\veone}{\vetwo}$ & $\EBinop(\op, \veone, \vetwo)$\texthypertarget{def-abbrevebcond}\\
$\AbbrevECond[H]{\veone}{\vetwo}{\vethree}$ & $\ECond(\veone, \vetwo, \vethree)$\hypertarget{def-abbrevtarray}{}\\
