...
\item[Optional.] An optional node stands for a list of 0 or 1 occurrences of a sub-node $n$. We denote an empty optional by $\some{}$ and the non-empty optional by $\some{n}$;
...
The meta relation
\[
\buildoption[b](\overname{N}{\vsym}) \;\aslrel\; \overname{\some{ A }}{\vsymast}
\]
which is parameterized by an AST building relation $b : E \aslrel A$,
...
\inferrule[some]{
  ...
  \buildoption[b](\overname{\namednode{\vv}{E}}{\vsym}) \astarrow \overname{\some{\astversion{\vv}}}{\vsymast}
}
\end{mathpar}
