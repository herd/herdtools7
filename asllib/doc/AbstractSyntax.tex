...
\ChapterOutline
\begin{itemize}
  \item \secref{AbstractSyntaxTrees} defines the type of Abstract Syntax Trees used by ASL;
  \item \secref{AbstractSyntaxGrammar} defines notations used for the AST grammar;
  ...
  \begin{itemize}
    ...
    \item \secref{BitFields} defines the AST for bit Fields;
  ...
  \end{itemize}
  \item \secref{UntypedAbstractGrammar} presents the grammar rules for the \untypedast;
  \item \secref{TypedAbstractSyntaxGrammar} presents the grammar rules for the \typedast;
