...
We call the construction of the AST for such constructs \emph{\desugaring}.
\end{definition}
...
\begin{itemize}
  ...
  \item \secref{AbstractSyntaxAbreviations} defines AST abbreviations used by inference rules throughout this reference.
\end{itemize}
