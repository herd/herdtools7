...
\begin{itemize}
  ...
  \end{itemize}
  \item \secref{TypedAbstractSyntax} defines the \typedast;
  \item \secref{BuildingAbstractSyntaxTrees} explains how we use inference rules to transform a parse tree into an \untypedast;
  \item \secref{BuildingParameterisedProductions} presents rules for building ASTs from parameterised productions;
...
\section{Typed Abstract Syntax\label{sec:TypedAbstractSyntax}}
...
\begin{itemize}
  ...
  \item $\EArray\{\EArrayLength: \veone, \EArrayValue: \vetwo\}$ is used to
    construct an integer-indexed array value in order to initialise an
    array-typed variable.
  \item $\EEnumArray\{\EArrayEnum: \name, \EArrayLabels: \vl_{1..k}, \EArrayValue: \vetwo\}$ is used
    to construct an enumeration-indexed array value in order to initialise an
    array-typed variable.
  \item $\EGetEnumArray(\ebase, \ekey)$ is used for accessing an enumerated
    array given by $\ebase$ at the entry given by $\ekey$.
  \item $\LESetEnumArray(\ebase, \eindex)$ is used for updating an enumerated
    array left-hand-side expression given by $\ebase$ at the index given by
    $\eindex$.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Building Parameterised Productions\label{sec:BuildingParameterisedProductions}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
