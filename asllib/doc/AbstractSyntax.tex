...
\begin{flalign*}
\unop \derives\ & \overtext{\BNOT}{\Tbnot} \;|\; \overtext{\NEG}{\Tminus} \;|\; \overtext{\NOT}{\Tnot}
& \hypertarget{ast-binop}{} \hypertarget{ast-bor}{} \hypertarget{ast-impl}{} \hypertarget{ast-beq}{} \hypertarget{ast-band}{}
\\
\binop  \derives\ & \overtext{\BAND}{\Tband} \;|\; \overtext{\BOR}{\Tbor} \;|\; \overtext{\IMPL}{\Tbimpl}
              \;|\; \overtext{\BEQ}{\Tbeq}
              & \hypertarget{ast-eqop}{} \hypertarget{ast-neq}{} \hypertarget{ast-gt}{} \hypertarget{ast-geq}{} \hypertarget{ast-lt}{} \hypertarget{ast-leq}{}
\\
        |\ & \overtext{\EQOP}{\Teqop} \;|\; \overtext{\NEQ}{\Tneq} \;|\; \overtext{\GT}{\Tgt}
        \;|\; \overtext{\GEQ}{\Tgeq} \;|\; \overtext{\LT}{\Tlt} \;|\; \overtext{\LEQ}{\Tleq}
        & \hypertarget{ast-plus}{} \hypertarget{ast-minus}{} \hypertarget{ast-or}{} \hypertarget{ast-xor}{} \hypertarget{ast-and}{}
\\
        |\ & \overtext{\PLUS}{\Tplus} \;|\; \overtext{\MINUS}{\Tminus} \;|\; \overtext{\OR}{\Tor}
        \;|\; \overtext{\XOR}{\Txor} \;|\; \overtext{\AND}{\Tand}
...
\\
        |\ & \overtext{\MUL}{\Tmul} \;|\; \overtext{\DIV}{\Tdiv} \;|\; \overtext{\DIVRM}{\Tdivrm}
        \;|\; \overtext{\MOD}{\Tmod} \;|\; \overtext{\SHL}{\shiftleftlexeme}  \;|\; \overtext{\SHR}{\shiftrightlexeme}
        & \hypertarget{ast-rdiv}{} \hypertarget{ast-pow}{} \hypertarget{ast-bvconcat}{} \hypertarget{ast-strconcat}{}
\\
        |\ & \overtext{\RDIV}{\Trdiv} \;|\; \overtext{\POW}{\Tpow} \;|\; \overtext{\BVCONCAT}{\Tcoloncolon} \;|\; \overtext{\STRCONCAT}{\Tplusplus}
        &
\end{flalign*}
