...
\subsubsection{ASTRule.DiscardOrIdentifier \label{sec:ASTRule.DiscardOrIdentifier}}
...
In \listingref{lediscardsemantics}, \texttt{- = 42;} does not affect the environment.
\ASLListing{Assignment to \texttt{-}}{lediscardsemantics}{\semanticstests/SemanticsRule.LEDiscard.asl}
...
In \listingref{semantics-levar}, \nameref{sec:SemanticsRule.LEVar} is (only) used
...
\subsubsection{Example}
In \listingref{semantics-ledestructuring}, \texttt{(x, y) = (3, 42)} binds
...
\subsubsection{Example}
\listingref{semantics-lesetarray}, binds the third element of \texttt{my\_array} to the value \texttt{53}.
...
\subsubsection{Example}
In \listingref{semantics-lesetfield},
\texttt{my\_record.a = 42;} binds \texttt{my\_record} to \texttt{\{a: 42, b: 100\}}
