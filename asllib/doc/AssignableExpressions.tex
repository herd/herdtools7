...
\begin{itemize}
  ...
  \item obtaining the width of the slices $\slicestwo$ in $\tenv$ and simplifying them yields $\vwidth$;
  ...
  \item checking that $\slicestwo$ is not empty yields $\True$\ProseTerminateAs{\BadSlices};
...
\inferrule{
  ...
  \sliceswidth(\tenv, \slicestwo) \typearrow \widthp\\
