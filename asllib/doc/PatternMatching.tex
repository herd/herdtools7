...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\FormalRelationsDef[defines the formal relations for patterns;]{Patterns}
...
\SectionDef[defines the match-all-values pattern;]
  {MatchingAllValues}{Matching All Values}
...
\SectionDef[defines the match-a-single-value pattern;]
  {MatchingASingleValue}{Matching a Single Value}
\subsection{Syntax}
\begin{flalign*}
...
\SectionDef[defines the match-a-range-of-integers pattern;]
  {MatchingARangeOfIntegers}{Matching a Range of Integers}
\subsection{Syntax}
\begin{flalign*}
...
\SectionDef[defines the less-than-or-equal pattern;]
  {MatchingAnUpperBoundedRangeOfIntegers}{Matching an Upper Bounded Range of Integers}
\subsection{Syntax}
\begin{flalign*}
...
\SectionDef[defines the greater-than-or-equal pattern;]
  {MatchingALowerBoundedRangeOfIntegers}{Matching a Lower Bounded Range of Integers}
\subsection{Syntax}
\begin{flalign*}
...
\SectionDef[defines the bitmask pattern;]
  {MatchingABitmask}{Matching a Bitmask}
...
\SectionDef[defines positive and negative matching against pattern lists.]
  {MatchingPatternLists}{Matching Pattern Lists}
...
\subsection{Typing}
\RenderRelation{annotate_pattern_matcher}
\RenderProseAndFormally{annotate_pattern_matcher}

\subsection{Semantics}
\SemanticsRuleDef{EvalPatternMatcher}
...
\RenderRelation{eval_pattern_matcher}
\RenderProseAndFormally{eval_pattern_matcher}
\CodeSubsection{\EvalPatternPatternMatcherBegin}{\EvalPatternPatternMatcherEnd}{../Interpreter.ml}
