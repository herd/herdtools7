...
\inferrule{}{
  {
  \begin{array}{r}
    \buildexprpattern(\Nexprpattern(\punnode{\Nexprpattern}, \Tin, \punnode{\Npatternormask})) \astarrow\\
    \overname{\EPattern(\astof{\vexprpattern}, \astof{\vpatternormask})}{\vastnode}
  \end{array}
  }
}
\end{mathpar}
