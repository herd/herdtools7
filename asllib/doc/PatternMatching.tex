...
\ASLListing{}{semantics-}{\semanticstests/SemanticsRule.PAll.asl}
...
\subsubsection{Example}
\ASLListing{}{semantics-}{\semanticstests/SemanticsRule.PSingleTRUE.asl}

\subsubsection{Example}
\ASLListing{}{semantics-}{\semanticstests/SemanticsRule.PSingleFALSE.asl}
...
\subsubsection{Example}
\ASLListing{}{semantics-}{\semanticstests/SemanticsRule.PRangeTRUE.asl}

\subsubsection{Example}
\ASLListing{}{semantics-}{\semanticstests/SemanticsRule.PRangeFALSE.asl}
...
\subsubsection{Example}
\ASLListing{}{semantics-}{\semanticstests/SemanticsRule.PLeqTRUE.asl}

\subsubsection{Example}
\ASLListing{}{semantics-}{\semanticstests/SemanticsRule.PLeqFALSE.asl}
...
\subsubsection{Example}
\ASLListing{}{semantics-}{\semanticstests/SemanticsRule.PGeqTRUE.asl}

\subsubsection{Example}
\ASLListing{}{semantics-}{\semanticstests/SemanticsRule.PGeqFALSE.asl}
...
\subsubsection{Example}
\ASLListing{}{semantics-}{\semanticstests/SemanticsRule.PMaskTRUE.asl}

\subsubsection{Example}
\ASLListing{}{semantics-}{\semanticstests/SemanticsRule.PMaskFALSE.asl}
...
\subsubsection{Example}
\ASLListing{}{semantics-}{\semanticstests/SemanticsRule.PTupleTRUE.asl}

\subsubsection{Example}
\ASLListing{}{semantics-}{\semanticstests/SemanticsRule.PTupleFALSE.asl}
...
\item define $\vses$ as the union of all $\vxs_\vl$, for each $\vl$ in $\vli$.
      ...
      \staticallyevaluable. See, for example, \nameref{sec:TypingRule.PSingle}.)
\end{itemize}
...
\subsubsection{Example}
\ASLListing{}{semantics-}{\semanticstests/SemanticsRule.PAnyTRUE.asl}

\subsubsection{Example}
\ASLListing{}{semantics-}{\semanticstests/SemanticsRule.PAnyFALSE.asl}
...
\subsubsection{Example}
\ASLListing{}{semantics-}{\semanticstests/SemanticsRule.PNotTRUE.asl}

\subsubsection{Example}
\ASLListing{}{semantics-}{\semanticstests/SemanticsRule.PNotFALSE.asl}
