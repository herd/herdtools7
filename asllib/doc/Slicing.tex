...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item checking that $\vsesoffset$ is pure via $\sesispure$ yields $\True$\ProseOrTypeError;
    \item checking that $\vseslength$ is pure via $\sesispure$ yields $\True$\ProseOrTypeError;
...
\inferrule[length]{
  ...
  \checktrans{\sesispure(\vsesoffset)}{\SideEffectViolation} \typearrow \True \OrTypeError\\\\
  \checktrans{\sesispure(\vseslength)}{\SideEffectViolation} \typearrow \True \OrTypeError\\\\
