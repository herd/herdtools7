...
\begin{mathpar}
\inferrule{
    \aslscan(\spectoken, \vstdtext) \scanarrow \vstdtokens \OrLexicalError\hva\\\\
    \aslparse(\vstdtokens) \parsearrow \vstdparse \OrParseError\hva\\\\
    \buildast(\vstdparse) \astarrow \vstdast \OrBuildError\hva\\\\
    ...
    \aslscan(\spectoken, \vspectext) \scanarrow \vspectokens \OrLexicalError\hva\\\\
    \aslparse(\vspectokens) \parsearrow \vspecparse \OrParseError\hva\\\\
    \buildast(\vspecparse) \astarrow \vspecast \OrBuildError\hva\\\\
    \vuntypedast \eqdef \vstdasbuiltin \concat \vspecast\\
    \typecheckast(\emptytenv.\staticenvsG, \vuntypedast) \typearrow (\vtypedast, \tenv) \OrTypeError\hva\\\\
