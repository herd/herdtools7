...
\input{ASLmacros}
\usepackage{tikz}
\newcommand{\tests}{../tests/ASLSyntaxReference.t/}
...
\paragraph{Outline}
The outline of this chapter is as follows,
We first define the type of Abstract Syntax Trees used by ASL (\secref{ASLAbstractSyntaxTrees}).
We then define the notations for defining the AST grammar used by ASL (\secref{ASLAbstractSyntaxGrammar})
...
\begin{figure}
\CodeExample{\tests/expr1.asl}
\caption{Examples of expressions \label{fi:expr1}}
\end{figure}

\begin{figure}
\CodeExample{\tests/expr2.asl}
