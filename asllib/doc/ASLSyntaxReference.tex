...
\[
\begin{array}{rcl}
\casealt &::=& \{ \CasePattern : \pattern, \CaseWhere : \expr?, \CaseStmt : \stmt \}\\
\catcher &::=& (\overtext{\identifier?}{exception to match}, \overtext{\ty}{guard type}, \overtext{\stmt}{statement to execute on match})
\end{array}
\]
