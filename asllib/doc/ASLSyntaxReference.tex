...
\newcommand\booltolit[0]{\textsf{bool\_to\_lit}}
...
\begin{mathpar}
\inferrule[literal]{}{
  \buildexpr(\Nexpr(\punnode{\Nvalue})) \astarrow
  \overname{\ELiteral(\astof{\vvalue})}{\vastnode}
}
\end{mathpar}
...
\begin{mathpar}
  \inferrule[var]{}{
  \buildexpr(\Nexpr(\Tidentifier(\id))) \astarrow
  \overname{\EVar(\id)}{\vastnode}
}
\end{mathpar}
...
\begin{mathpar}
  \inferrule[binop]{}{
    {
      \begin{array}{r}
  \buildexpr(\Nexpr(\punnode{\Nexpr}, \punnode{\Nbinop}, \punnode{\Nexpr})) \astarrow\\
  \overname{\EBinop(\astof{\vexpr}, \astof{\vbinop}, \astof{\vexpr})}{\vastnode}
      \end{array}
    }
}
\end{mathpar}
...
\begin{mathpar}
  \inferrule[unop]{}{
  \buildexpr(\Nexpr(\punnode{\Nunop}, \punnode{\Nexpr})) \astarrow
  \overname{\EUnop(\astof{\vunop}, \astof{\vexpr})}{\vastnode}
}
\end{mathpar}
...
\begin{mathpar}
  ...
  \buildexpr(\Nexpr(\Tidentifier(\id), \namednode{\vargs}{\Plist{\Nexpr}})) \astarrow
  \overname{\ECall(\id, \vexprasts)}{\vastnode}
}
\end{mathpar}
...
\begin{mathpar}
  \inferrule[slice]{}{
    {
      \begin{array}{r}
  \buildexpr(\Nexpr(\punnode{\Nexpr}, \punnode{\Nslice})) \astarrow\\
...
\begin{mathpar}
  \inferrule[get\_field]{}{
  \buildexpr(\Nexpr(\Nexpr, \Tdot, \Tidentifier)) \astarrow
  \overname{\EGetField()}{\vastnode}
}
\end{mathpar}
...
\begin{mathpar}
  \inferrule[get\_fields]{
    ...
    {
      \begin{array}{r}
  \buildexpr(\Nexpr(\punnode{\Nexpr}, \Tdot, \Tlbracket, \namednode{\vids}{\NClist{\Tidentifier}}, \Trbracket)) \astarrow\\
...
\begin{mathpar}
  \inferrule[atc]{}{
    {
      \begin{array}{r}
  \buildexpr(\Nexpr(\punnode{\Nexpr}, \Tas, \punnode{\Nty})) \astarrow\\
...
\begin{mathpar}
  \inferrule[atc\_int\_constraints]{}{
    {
      \begin{array}{r}
  \buildexpr(\Nexpr(\punnode{\Nexpr}, \Tas, \punnode{\Nintconstraints})) \astarrow\\
...
\begin{mathpar}
  \inferrule[pattern\_set]{}{
    {
      \begin{array}{r}
  \buildexpr(\Nexpr(\punnode{\Nexpr}, \Tin, \punnode{\Npatternset})) \astarrow\\
...
\begin{mathpar}
  \inferrule[pattern\_mask]{}{
    {
      \begin{array}{r}
  \buildexpr(\Nexpr(\punnode{\Nexpr}, \Tin, \Tmasklit(\vm))) \astarrow\\
...
\begin{mathpar}
  \inferrule[unknown]{}{
  \buildexpr(\Nexpr(\Tunknown, \Tcolon, \punnode{\Nty})) \astarrow
  \overname{\EUnknown(\astof{\tty})}{\vastnode}
}
\end{mathpar}
...
\begin{mathpar}
  \inferrule[sub\_expr]{}{
  \buildexpr(\Nexpr(\Tlpar, \punnode{\Nexpr}, \Trpar)) \astarrow
  \overname{\astof{\vexpr}}{\vastnode}
}
\end{mathpar}
...
\begin{mathpar}
  ...
  \buildexpr(\Nexpr(\namednode{\vexprs}{\Plisttwo{\Nexpr}})) \astarrow
...
\inferrule[non\_empty]{
  ...
  \buildlist[b](\overname{\namednode{\vv}{E}, \namednode{\vsymsone}{\maybeemptylist{N}}}{\vsyms}) \astarrow \overname{[\astversion{\vv}] \concat \vsymastsone}{\vsymasts}
}
\end{mathpar}
