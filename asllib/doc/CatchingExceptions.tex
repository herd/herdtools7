...
The relation
\[
  \evalcatchers(\overname{\envs}{\env} \aslsep \overname{\KleeneStar{\catcher}}{\catchers} \aslsep \overname{\langle\stmt\rangle}{\otherwiseopt}
...
\inferrule{
  ...
  \evalcatchers(\env, \catchers, \langle\vs\rangle, \sm) \evalarrow \withgraph{C}{\vg}
}
\end{mathpar}
