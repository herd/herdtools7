...
\inferrule{
  ...
  \staticeval(\tenv, \ewidth) \typearrow \LInt(\vwidth) \OrTypeError\\\\
  \vf\in\fields: \annotatebitfield(\tenv, \vwidth, \vfield) \typearrow (\vfp, \vxs_\vf) \OrTypeError\\\\
...
\inferrule[nested]{
  ...
  \checkpositionsinwidth(\tenv, \vwidth, \positions) \typearrow \True \OrTypeError\\\\
...
\inferrule[type]{
  ...
  \checkslicesinwidth(\tenv, \vwidth, \slicesone) \typearrow \True \OrTypeError\\\\
  \disjointslicestopositions(\tenv, \True, \slicesone) \typearrow \positions \OrTypeError\\\\
  \checkpositionsinwidth(\tenv, \slicesone, \vwidth, \positions) \typearrow \True \OrTypeError\\\\
  \widthp \eqdef \listlen{\positions}\\
