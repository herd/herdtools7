...
\begin{itemize}
\item The \hypertarget{def-absolutename}{\absolutename} of a (possibly-nested) bitfield is the list of identifiers starting from the
...
\item The \hypertarget{def-absoluteslice}{\absoluteslice} of a bitfield comprises of the slices it defines with respected to its containing
bitvector type;
...
and \texttt{fmt1.common} are not in the same scope, since neither \texttt{fmt0} nor \texttt{fmt1} are a prefix of the other.
