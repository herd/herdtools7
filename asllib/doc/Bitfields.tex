...
Bitvector types allow defining slices, which we refer to as \emph{bitfields}.
...
\paragraph{Semantics:} Bitfields are not directly associated with a dynamic semantic.
  Their semantics is given as part of slicing expressions
  by $\evalexprname$ (see \secref{SlicingExpressions}) and
  $\evallexprname$ (see \secref{BitvectorSliceAssignmentExpressions}).
