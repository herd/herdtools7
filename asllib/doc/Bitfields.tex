...
and a slice of the form \texttt{[$\veone$+:$\vetwo$]} as a \lengthslice.
...
equal.
This is formalised in \TypingRuleRef{CheckCommonBitfieldsAlign} and exemplified in \listingref{nestedbitfields}.
...
The function assumes that AST nodes labelled with $\SliceSingle$ and $\SliceRange$ have been reduced
