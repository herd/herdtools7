...
% BEGIN_GENERATED_ELEMENT(bitfield)[remove_hypertargets]
\begin{flalign*}
\bitfield \derives\ & \BitFieldSimple(\overtext{\Identifier}{name}, \overtext{\KleeneStar{\slice}}{slices})\\
|\ & \BitFieldNested(\overtext{\Identifier}{name}, \overtext{\KleeneStar{\slice}}{slices}, \overtext{\KleeneStar{\bitfield}}{nested bitfields})\\
