%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\SectionDef[defines predicates for classifying types and functions for inspecting their structure;]
  {BasicTypeAttributes}{Basic Type Attributes}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

This section defines some basic predicates for classifying types as well as
functions that inspect the structure of types:
\begin{TypingRuleList}{TypeAttributes}

\TypingRuleDef[defines builtin singular types.]{BuiltinSingularType}
...
\TypingRuleDef[defines named types.]{NamedType}
...
\TypingRuleDef[defines anonymous types.]{AnonymousType}
 %
...
\TypingRuleDef[defines singular types.]{SingularType}
%
...
\TypingRuleDef[defines structured types.]{StructuredType}
...
\TypingRuleDef[defines the \structureterm{} of a type.]{Structure}
The \hypertarget{def-tstruct}{\emph{\structureterm}} of a type is the type that results from replacing all named types
...
\TypingRuleDef[defines the \underlyingtypeterm{} of a type.]{MakeAnonymous}
The \emph{\underlyingtypeterm{}} of a type is the
first non-\namedtype{} that is used to define it.
...
\TypingRuleDef[checks whether a type is a \constrainedintegerterm{}.]{CheckConstrainedInteger}
