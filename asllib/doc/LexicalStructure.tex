...
% INLINED_EXAMPLE
For example, in \verb|'10100'| the \ProseMSB{} \verb|1| is at index $4$,
...
The function
\[
\remaxmatch : \overname{\RegExp}{e} \cartimes \overname{\Strings}{s} \aslto (\overname{\Strings}{s_1} \cartimes \overname{\Strings}{s_2}) \cup \{\bot\}
\]
...
\hypertarget{operator-decimaltolit}{}
...
\item The function $\vbitstolit(s)$ returns $\Tbitvectorlit(b)$ where $b$ is the sequence of bits
      given by $s$.
...
$\REbitvectorlit$                     & $\actiontoken(\vbitstolit)$ \\
