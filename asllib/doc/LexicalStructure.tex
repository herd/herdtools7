...
\begin{center}
\begin{tabular}{rcl}
$\RElinecomment$  &$\triangleq$& \texttt{"//"} (\REchar\ \regexminus{} \ascii{10})*\\
\end{tabular}
\end{center}
...
\SectionDef[defines string literals,]
...
\SectionDef[defines identifiers, and]
...
\[
\discardcommentchar(s_1, s_2) \triangleq \aslscan(\speccomment, s_2)
\]
