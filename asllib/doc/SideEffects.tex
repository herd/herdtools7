...
\begin{description}
    \item[\RenderConstant{SE_Pure}] describes evaluation of a \pure{} construct, one that can be evaluated at type-checking.

\item[\RenderConstant{SE_Readonly}] describes evaluation of a \readonly{} construct, one that can read mutable global storage elements but not modify them.

\item[\RenderConstant{SE_Impure}] describes evaluation of a construct that is neither \pure{} nor \readonly{}.
\end{description}
