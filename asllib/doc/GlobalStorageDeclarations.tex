...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item the evaluation of the expression $\ve$ in $\env$ yields $\ExprResult((\vv, \vgtwo), \envtwo)$\ProseOrAbnormal;
...
\inferrule[non\_empty]{
  ...
  \evalexpr{ \env, \ve} \evalarrow \ExprResult((\vv,\vgtwo), \envtwo) \OrAbnormal\\\\
