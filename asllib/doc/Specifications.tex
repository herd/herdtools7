...
declarations also leads to a \typingerrorterm{}, but the type errors may not be the same
...
\ExampleDef{The Dependencies Global Declarations}
...
\ASLListing{Dependencies of global decalrations}{DeclDependencies}{\typingtests/TypingRule.DeclDependencies.asl}
...
shows examples of global declarations and the identifiers the use,
...
\ASLListing{Identifiers used by global decalrations}{UseDecl}{\typingtests/TypingRule.UseDecl.asl}
