...
type local_decl_item =
  ...
  | LDI_Tuple of identifier option list
      (** [LDI_Tuple names] is the tuple declarations of [names],
          each of which is either an identifier or a discard.
          For example: {v let (x, y, -, z) = (1, 2, 3, 4); v}
