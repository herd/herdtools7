...
func impure_func{x: integer, y: integer}() => integer{x * y + y}
begin
    if x == 0 then
        throw my_exception{-};
    end;
...
type MyInteger of integer{9}; // The underlying type of MyInteger is integer{9}.
...
begin
    ...
    // constrained integer type can be used as array length expressions:
