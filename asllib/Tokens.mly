...
%token CATCH COLON COLON_COLON COMMA CONFIG CONSTANT DEBUG DIV DIVRM DO
...
%token PRAGMA PRINTLN PRINT
%token RBRACE RBRACKET RDIV REAL RECORD RECURSELIMIT REPEAT RETURN RPAR
%token STAR_COLON SEMI_COLON SETTER SHL SHR SLICING STRING SUBTYPES THEN
%token THROW TO TRY TYPE ARBITRARY UNREACHABLE UNTIL VAR WHEN WHERE WHILE WITH
