...
readonly func set_first(bv:MyBitVector, b:bits(1)) => MyBitVector
begin
  var bv_bis = bv;
  bv_bis.first = b;
  return bv_bis;
...
readonly func get_first_three(bv:MyBitVector) => bits(3)
begin
  return bv.first_three;
end;

readonly func as_MyBitVector(x:bits(5)) => MyBitVector
begin
  return x;
end;
