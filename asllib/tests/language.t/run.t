...
Test Rgrvj.asl:
  $ aslref Rgrvj.asl
  File Rgrvj.asl, line 5, characters 11 to 29:
...
Test Idmnl.asl:
  $ aslref Idmnl.asl
  ASL Execution error: Illegal application of operator == for values "Hello"
    and "Hello".
  [1]
For reference, the test writter intention was that this output matched:
...
Test Rwkcy.asl:
  $ aslref Rwkcy.asl
  File Rwkcy.asl, line 6, characters 11 to 17:
  ASL Internal error: Not yet implemented: Base value of string types.
  [1]
For reference, the test writter intention was that this output matched:
...
Test Itsxl.asl:
  $ aslref Itsxl.asl
  File Itsxl.asl, line 9, characters 10 to 17:
...
Test Rwzcs.asl:
  $ aslref Rwzcs.asl
  ASL Typing error: Cannot extract from bitvector of length 0 slices 4+:-2.
  [1]
