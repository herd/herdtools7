(* Constraint multiplication *)
  ...
  File constraint-mul-06.asl, line 6, characters 12 to 21:
  Exploding sets in for the binary operation DIVRM would result in too big a
  constraint set with constraints 0..512 and 1..512. Continuing with those.
  ...
  constraint set with constraints 0..512 and 0..512. Continuing with those.
  ...
  File constraint-mul-07.asl, line 6, characters 12 to 21:
  Exploding sets in for the binary operation DIVRM would result in too big a
  constraint set with constraints 0..1024 and 1..1024. Continuing with those.
  File constraint-mul-07.asl, line 7, characters 13 to 18:
  Exploding sets in for the binary operation * would result in too big a
  constraint set with constraints 0..1024 and 0..1024. Continuing with those.
  ...
  File constraint-mul-08.asl, line 6, characters 12 to 21:
  Exploding sets in for the binary operation DIVRM would result in too big a
  constraint set with constraints 0..2048 and 1..2048. Continuing with those.
  File constraint-mul-08.asl, line 7, characters 13 to 18:
  Exploding sets in for the binary operation * would result in too big a
  constraint set with constraints 0..2048 and 0..2048. Continuing with those.
  ...
  File constraint-mul-09.asl, line 6, characters 12 to 21:
  Exploding sets in for the binary operation DIVRM would result in too big a
  constraint set with constraints 0..4096 and 1..4096. Continuing with those.
  File constraint-mul-09.asl, line 7, characters 13 to 18:
  Exploding sets in for the binary operation * would result in too big a
  constraint set with constraints 0..4096 and 0..4096. Continuing with those.
  ...
  File constraint-mul-10.asl, line 6, characters 12 to 21:
  Exploding sets in for the binary operation DIVRM would result in too big a
  constraint set with constraints 0..8192 and 1..8192. Continuing with those.
  File constraint-mul-10.asl, line 7, characters 13 to 18:
  Exploding sets in for the binary operation * would result in too big a
  constraint set with constraints 0..8192 and 0..8192. Continuing with those.
