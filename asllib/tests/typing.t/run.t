H Examples
  ...
  File HExample15.asl, line 3, characters 10 to 17: Warning: Removing some
  values that would fail with op DIV from constraint set {1, 2, (1 DIV 2)} gave
  {1, 2}. Continuing with this constraint set.
