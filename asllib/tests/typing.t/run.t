H Examples
  ...
  File HExample16.asl, line 10, characters 19 to 36:
    let x: bits(a) = Reverse{a}(bv, b);
                     ^^^^^^^^^^^^^^^^^
  ASL Type error (TE_TSF): Expected a subtype of integer {1..a};
  ...
  File HExample18.asl, line 12, characters 20 to 39:
    let x: bits(a2) = Reverse{a2}(bv, a2);
                      ^^^^^^^^^^^^^^^^^^^
  ASL Type error (TE_TSF): Expected a subtype of integer {1..a2};
    provided integer {8, 16, 32, 64}.
  [1]
...
Assignments of constrained integers
  ...
  File TNegative2-1.asl, line 4, characters 4 to 42:
      ...
      ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  ASL Type error (TE_TSF): Expected a subtype of integer {8, 16, 32};
    provided integer {8, 16, 32, 64}.
  [1]
...
Use of global vars in constraints
  ...
  File TPositive4-1.asl, line 5, characters 4 to 54:
      ...
      ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  ASL Type error (TE_TSF): Expected a subtype of integer {8};
    provided integer {16}.
  [1]
  ...
  File TPositive4-2.asl, line 8, characters 4 to 54:
      ...
      ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  ASL Type error (TE_TSF): Expected a subtype of integer {LET_ALLOWED_NUMS_C};
    provided integer {16}.
  [1]
  ...
  File TPositive4-4.asl, line 9, characters 4 to 54:
      ...
      ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  ASL Type error (TE_TSF): Expected a subtype of integer {CONFIG_ALLOWED_NUMS};
    provided integer {16}.
  [1]
  ...
  File TReconsider4-1.asl, line 14, characters 4 to 54:
      ...
      ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  ASL Type error (TE_TSF): Expected a subtype of integer {0..8};
    provided integer {10}.
  [1]
...
Asserted type conversions
  ...
  File TNegative5-0.asl, line 5, characters 4 to 38:
      ...
      ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  ASL Type error (TE_TSF): Expected a subtype of integer {0..3};
...
Named types
  ...
  File TNegative7.asl, line 7, characters 4 to 36:
      ...
      ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  ASL Type error (TE_TSF): Expected a subtype of MyOtherSizes;
...
Loops
  ...
  File TPositive8-1.asl, line 5, characters 8 to 40:
          ...
          ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  ASL Type error (TE_TSF): Expected a subtype of integer {8..31};
  ...
  File TNegative8-0.asl, line 5, characters 8 to 40:
          ...
          ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  ASL Type error (TE_TSF): Expected a subtype of integer {0..7};
    provided integer.
  [1]
  ...
  File TNegative8-2.asl, line 5, characters 8 to 40:
          ...
          ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  ASL Type error (TE_TSF): Expected a subtype of integer {7..31};
    provided integer.
  [1]
...
Bit vector widths defined by constrained integers
  ...
  File TNegative9-0.asl, line 3, characters 4 to 36:
      ...
      ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  ASL Type error (TE_TSF): Expected a subtype of bits(8); provided bits(16).
  [1]
  ...
  File TNegative9-2.asl, line 3, characters 4 to 35:
      ...
      ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  ASL Type error (TE_TSF): Expected a subtype of bits(M); provided bits(N).
  [1]
  ...
  File TNegative9-4.asl, line 3, characters 4 to 35:
      ...
      ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  ASL Type error (TE_TSF): Expected a subtype of bits(N); provided bits(8).
  [1]
...
Symbolic execution of bit vector widths expressions
  ...
  File TNegative10-0.asl, line 16, characters 4 to 53:
      ...
      ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  ASL Type error (TE_TSF): Expected a subtype of bits(letWidthN1);
  ...
  File TNegative10-1.asl, line 28, characters 4 to 49:
      ...
      ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  ASL Type error (TE_TSF): Expected a subtype of bits(tempC3A);
...
Complex symbolic execution of bit vector widths expressions
  ...
  File TPositive11.asl, line 11, characters 4 to 64:
      ...
      ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  ASL Type error (TE_TSF): Expected a subtype of bits(numBits);
...
Named types for bit vector widths
  ...
  File TNegative14-0.asl, line 6, characters 4 to 32:
      ...
      ^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  ASL Type error (TE_TSF): Expected a subtype of NamedTypeB;
    provided NamedTypeA.
  [1]
  ...
  File TNegative14-1.asl, line 7, characters 4 to 39:
      ...
      ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  ASL Type error (TE_TSF): Expected a subtype of bits(w1); provided bits(w2).
  [1]
...
C Tests
  ...
  File CPositive7.asl, line 4, characters 4 to 31:
      ...
      ^^^^^^^^^^^^^^^^^^^^^^^^^^^
  ASL Type error (TE_TSF): Expected a subtype of integer {0..(2 * N)};
  ...
  ASL Type error (TE_TSF): Expected a subtype of bits(64);
    provided bits((N + 5)).
  [1]
  ...
  File CNegative5.asl, line 13, characters 2 to 33:
    ...
    ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  ASL Type error (TE_TSF): Expected a subtype of integer {12};
    provided integer {3}.
  [1]
