func operator_priority(
    ...
    begin
        let p_m_s = a * b - c;
        // '*' has higher priority than '-' so interpreted as:
        let p_m_s_I = (a * b) - c;
        ...
        let p_band_eq = g && a == b;
        // '&&' is of priority class 'Boolean'.
        // '==' is of priority class 'Comparison'.
        // 'Comparison' has higher priority than 'Boolean' so interpreted as:
