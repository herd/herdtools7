  ...
  ASL Type error (TE_SEV):
    Side effects WritesGlobal "X" and ReadsGlobal "X" conflict.
  [1]
  ...
  File binop-write-write.asl, line 11, characters 10 to 47:
    let y = set_and_return () + set_and_return ();
            ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  ASL Type error (TE_SEV):
    Side effects WritesGlobal "X" and WritesGlobal "X" conflict.
  [1]
  ...
  File binop-throw-write.asl, line 18, characters 12 to 43:
      let y = throwing () + set_and_return ();
              ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  ASL Type error (TE_SEV):
    Side effects ThrowsException "E" and WritesGlobal "X" conflict.
  [1]
  ...
  File binop-throw-throw.asl, line 11, characters 12 to 37:
      let y = throwing () + throwing ();
              ^^^^^^^^^^^^^^^^^^^^^^^^^
  ASL Type error (TE_SEV):
    Side effects ThrowsException "E" and ThrowsException "E" conflict.
  [1]
...
// $ aslref binop-atc-atc.asl
  ...
  ASL Type error (TE_SEV):
    Side effects ReadsLocal "x" and WritesLocal "x" conflict.
  [1]
  ...
  ASL Type error (TE_SEV):
    Side effects ReadsGlobal "X" and WritesGlobal "X" conflict.
  [1]
  ...
  File rec-binop-atc-throw.asl, line 15, characters 10 to 54:
    let x = throwing (n - 1, FALSE) * (2 as integer {3});
            ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  ASL Type error (TE_SEV):
    Side effects CallsRecursive "throwing" and PerformsAssertions conflict.
  [1]
  ...
  File rec-binop-read-throw.asl, line 22, characters 10 to 45:
    let x = throwing (n - 1, FALSE) * read_X ();
            ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  ASL Type error (TE_SEV):
    Side effects CallsRecursive "throwing" and ReadsGlobal "X" conflict.
  [1]
  ...
  File rec-binop-read.asl, line 17, characters 10 to 42:
    let x = not_throwing (n - 1) * read_X ();
            ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  ASL Type error (TE_SEV):
    Side effects CallsRecursive "not_throwing" and ReadsGlobal "X" conflict.
  [1]
  ...
  File rec-binop-write.asl, line 18, characters 10 to 43:
    let x = not_throwing (n - 1) * write_X ();
            ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  ASL Type error (TE_SEV):
    Side effects CallsRecursive "not_throwing" and WritesGlobal "X" conflict.
  [1]
  ...
  File rec-assert.asl, line 9, characters 10 to 51:
    let x = not_throwing (n - 1) * (2 as integer {3});
            ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  ASL Type error (TE_SEV):
    Side effects CallsRecursive "not_throwing" and PerformsAssertions conflict.
  [1]
  ...
  File rec-binop-write-throw.asl, line 23, characters 10 to 46:
    let x = throwing (n - 1, FALSE) * write_X ();
            ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  ASL Type error (TE_SEV):
    Side effects CallsRecursive "throwing" and WritesGlobal "X" conflict.
  [1]
  ...
  File rec-binop-rec.asl, line 9, characters 10 to 35:
    let x = bar (n - 1) * bar (n - 2);
            ^^^^^^^^^^^^^^^^^^^^^^^^^
  ASL Type error (TE_SEV):
    Side effects CallsRecursive "bar" and CallsRecursive "bar" conflict.
  [1]
  ...
  ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  ASL Dynamic error (DE_UE): Unexpected exception E
