  ...
  let disclaimer =
    Printf.sprintf
      "-- DISCLAIMER: This file has been autogenerated by %s.\n\
       -- This file is **NOT** a reference implementation and should not be \
       treated as such!\n\
       -- Modifications of this file will lead to an **UNSUPPORTED** \
       divergence from the reference implementation and should **NOT** be \
       done!\n\n"
      prog_name
  in
