...
(* Pretty print, macros are filtered and printed specially *)
        let pp_relax r =
          ...
          | ERS [e] -> E.pp_edge e
          | ERS
              [{edge=Rf Ext; a1=None;a2=None;_};
               {edge=Fenced _;a1=None; a2=None;_} as e] ->
                 sprintf "AC%s" (pp_edge e)
          | ERS [{edge=Fenced _; a1=None;a2=None;_} as e;
                 {edge=Rf Ext; a1=None; a2=None;_}] ->
                   sprintf "BC%s" (pp_edge e)
          | ERS [{edge=Rf Ext; a1=None; a2=None;_};
                 {edge=Fenced _; a1=None; a2=None;_} as e;
                 {edge=Rf Ext; a1=None; a2=None;_}] ->
                   sprintf "ABC%s" (pp_edge e)
          | ERS [{edge=Dp _; a1=None; a2=None;_} as e;
                 {edge=Rf Ext; a1=None; a2=None;_}] ->
                   sprintf "BC%s" (pp_edge e)
          | ERS es ->
