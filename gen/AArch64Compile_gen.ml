...
(**********)
    ...
    | Some d,Data loc ->
        ...
        *)
        ...
        | d,atom -> fatal_annotation d atom
        end in
            ...
            | MemoryTagAccess ->
                ...
                let rA,init,st =
                  U.next_init st p init
                    (add_tag (Some structured_atom) loc (Value.to_int e.C.v)) in
