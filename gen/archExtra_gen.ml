...
module type I = sig
  ...
  val pp_i : int -> string
  module Value:Value.S with type pte_atom = arch_extra_atom
end
...
module type S = sig
  ...
  (* TODO can we do better without remaning? *)
  module Value_extra : Value.S with type pte_atom = arch_extra_atom
