...
illustrative_tests = [
    ...
    "tests/LB+rel+data-post.litmus",
    "tests/CAS+data1.litmus",
    "tests/CAS+data2.litmus",
    "tests/LB+rel+CAS.litmus",
    "tests/LB+rel+CAS+BIS.litmus",
    "tests/LB+rel+LDADD.litmus",
    "tests/LB+rel+STADD.litmus",
    ...
    "tests/MP+rel+acqpc.litmus",
    "tests/MP+rel+swp-acq.litmus",
    "tests/MP+rel+swp-acqpc.litmus",
    "tests/SB+dmb.sy+rel-acq.litmus",
    "tests/SB+dmb.sy+rel-acqpc.litmus",
