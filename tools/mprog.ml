...
module Top
  ...
  struct
    ...
    (* Transpose dump *)
    module Transpose(A:ArchBase.S)(Pte:PteVal.S)(Intid:IntidVal.S) = struct
...
(* Compute global location referenced from code and init *)
    ...
    (* No alloc *)
    module Text(A:ArchBase.S)(Pte:PteVal.S)(Intid:IntidVal.S) = struct
    ...
    (* Some alloc *)
    module TextAlloc(A:ArchBase.S)(Pte:PteVal.S)(Intid:IntidVal.S) = struct
      module Arch = ArchExtra_tools.Make(O)(A)(Pte)(Intid)
    ...
    module Latex(A:ArchBase.S)(Pte:PteVal.S)(Intid:IntidVal.S) = struct
      module Arch = ArchExtra_tools.Make(O)(A)(Pte)(Intid)
