Run litmus2desc on readers-guide tests in sorted order and compare output.
  ...
  $ for f in $(LC_ALL=C ls -1 rg_litmus_tests | sort); do
  >   echo "== $f =="; echo;
  >   cat "rg_litmus_tests/$f"; echo;
  >   litmus2desc -set-libdir ./libdir --describe-dep-path "rg_litmus_tests/$f"; echo;
  > done
  == CoRR.litmus ==
  ...
  * The Register X1 on P1 holds the value 1 in the end, because the Explicit Memory Read Effect of Location x on P1 generated by LDR W1,[X0] Reads-from the Explicit Memory Write Effect on P0;
  * The Register X2 on P1 holds the value 0 in the end, because the Explicit Memory Read Effect of Location x on P1 generated by LDR W2,[X0] Reads-from the initial state, and therefore is Coherence-before the Explicit Memory Write Effect on P0.
  ...
  * The Register X1 on P0 holds the value 1 in the end, because the Explicit Memory Read Effect Reads-from the Explicit Memory Write Effect.
  ...
  * The Register X1 on P0 holds the value 2 in the end, because the Explicit Memory Read Effect on P0 Reads-from the Explicit Memory Write Effect on P1.
  ...
  * The value of x is 1 in the end, because the Store instruction on P0 has updated the memory;
  * The Register X2 on P0 holds the value 0 in the end, because the Explicit Memory Read Effect Reads-from the initial state, and therefore is Coherence-before the Explicit Memory Write Effect.
  ...
  * The second Store instruction in program order on P0, i.e. STR W2,[X1], generates an Explicit Memory Write Effect of Location x with value 2;
  * The value of x is 1 in the end, because the Explicit Memory Write Effect of Location x generated by STR W2,[X1] is Coherence-before the Explicit Memory Write Effect of Location x generated by STR W0,[X1].
  ...
  * The Register X4 on P1 holds the value 1 in the end, because the Explicit Memory Read Effect on P1 Reads-from the Explicit Memory Write Effect of Location y on P0 generated by STR W2,[X3];
  * The Register X7 on P2 holds the value 1 in the end, because the Explicit Memory Read Effect of Location z on P2 generated by LDR W7,[X6] Reads-from the Explicit Memory Write Effect on P1;
  * The Register X8 on P2 holds the value 0 in the end, because the Explicit Memory Read Effect of Location x on P2 generated by LDR W8,[X1] Reads-from the initial state, and therefore is Coherence-before the Explicit Memory Write Effect of Location x on P0 generated by STR W0,[X1].
  ...
  * The Register X1 on P0 holds the value 1 in the end, because the Explicit Memory Read Effect on P0 Reads-from the Explicit Memory Write Effect on P1;
  * The Register X1 on P1 holds the value 1 in the end, because the Explicit Memory Read Effect on P1 Reads-from the Explicit Memory Write Effect on P0.
  ...
  * The second Load instruction in program order on P1, i.e. LDR W6,[X1], generates an Explicit Memory Read Effect of Location x;
  * The Register X4 on P1 holds the value 1 in the end, because the Explicit Memory Read Effect of Location y on P1 generated by LDR W4,[X3] Reads-from the Explicit Memory Write Effect of Location y on P0 generated by STR W2,[X3];
  * The Register X6 on P1 holds the value 0 in the end, because the Explicit Memory Read Effect of Location x on P1 generated by LDR W6,[X1] Reads-from the initial state, and therefore is Coherence-before the Explicit Memory Write Effect of Location x on P0 generated by STR W0,[X1].
  ...
  * The Register X0 on P1 holds the value 1 in the end, because the Explicit Memory Read Effect of Location y on P1 generated by LDR W0,[X3] Reads-from the Explicit Memory Write Effect of Location y on P0 generated by STR W2,[X3];
  * The Register X6 on P1 holds the value 1 in the end, because the Explicit Memory Read Effect of Location z on P1 generated by LDR W6,[X5] Reads-from the Explicit Memory Write Effect on P1;
  * The Register X8 on P1 holds the value 0 in the end, because the Explicit Memory Read Effect of Location x on P1 generated by LDR W8,[X1,W7,SXTW] Reads-from the initial state, and therefore is Coherence-before the Explicit Memory Write Effect of Location x on P0 generated by STR W0,[X1].
  ...
  * The Store instruction on P1, i.e. STR W4,[X5,W2,SXTW], generates an Explicit Memory Write Effect of Location z with value 1;
  * The second Load instruction in program order on P1, i.e. LDR W6,[X5], generates an Explicit Memory Read Effect of Location z;
  * The Branch instruction on P1, i.e. CBNZ W6,LC00, does not create any dependency to the Load instruction at label LC00 on P1, i.e. LDR W7,[X1];
  * The Load instruction at label LC00 on P1, i.e. LDR W7,[X1], generates an Explicit Memory Read Effect of Location x;
  * The Register X0 on P1 holds the value 1 in the end, because the Explicit Memory Read Effect of Location y on P1 generated by LDR W0,[X3] Reads-from the Explicit Memory Write Effect of Location y on P0 generated by STR W2,[X3];
  * The Register X6 on P1 holds the value 1 in the end, because the Explicit Memory Read Effect of Location z on P1 generated by LDR W6,[X5] Reads-from the Explicit Memory Write Effect on P1;
  * The Register X7 on P1 holds the value 0 in the end, because the Explicit Memory Read Effect of Location x on P1 generated by LDR W7,[X1] Reads-from the initial state, and therefore is Coherence-before the Explicit Memory Write Effect of Location x on P0 generated by STR W0,[X1].
  ...
  * The Register X0 on P1 holds the value 1 in the end, because the Explicit Memory Read Effect of Location y on P1 generated by LDR W0,[X3] Reads-from the Explicit Memory Write Effect of Location y on P0 generated by STR W2,[X3];
  * The Register X5 on P1 holds the value 1 in the end, because the Explicit Memory Read Effect of Location z on P1 generated by LDR W5,[X4] Reads-from the Explicit Memory Write Effect on P1;
  * The Register X7 on P1 holds the value 0 in the end, because the Explicit Memory Read Effect of Location x on P1 generated by LDR W7,[X1,W6,SXTW] Reads-from the initial state, and therefore is Coherence-before the Explicit Memory Write Effect of Location x on P0 generated by STR W0,[X1].
  ...
  * The Store instruction on P1, i.e. STR W2,[X4], generates an Explicit Memory Write Effect of Location z with value 1;
  * The second Load instruction in program order on P1, i.e. LDR W5,[X4], generates an Explicit Memory Read Effect of Location z;
  * The second Branch instruction in program order on P1, i.e. CBNZ W5,LC01, does not create any dependency to the Load instruction at label LC01 on P1, i.e. LDR W6,[X1];
  * The Load instruction at label LC01 on P1, i.e. LDR W6,[X1], generates an Explicit Memory Read Effect of Location x;
  * The Register X0 on P1 holds the value 1 in the end, because the Explicit Memory Read Effect of Location y on P1 generated by LDR W0,[X3] Reads-from the Explicit Memory Write Effect of Location y on P0 generated by STR W2,[X3];
  * The Register X5 on P1 holds the value 1 in the end, because the Explicit Memory Read Effect of Location z on P1 generated by LDR W5,[X4] Reads-from the Explicit Memory Write Effect on P1;
  * The Register X6 on P1 holds the value 0 in the end, because the Explicit Memory Read Effect of Location x on P1 generated by LDR W6,[X1] Reads-from the initial state, and therefore is Coherence-before the Explicit Memory Write Effect of Location x on P0 generated by STR W0,[X1].
  ...
  * The Store instruction on P1, i.e. STR W2,[X4], generates an Explicit Memory Write Effect of Location z with value 1;
  * The second Load instruction in program order on P1, i.e. LDR W5,[X4], generates an Explicit Memory Read Effect of Location z;
  * The Branch instruction on P1, i.e. CBNZ W5,LC00, does not create any dependency to the Load instruction at label LC00 on P1, i.e. LDR W6,[X1];
  * The Load instruction at label LC00 on P1, i.e. LDR W6,[X1], generates an Explicit Memory Read Effect of Location x;
  * The Register X0 on P1 holds the value 1 in the end, because the Explicit Memory Read Effect of Location y on P1 generated by LDR W0,[X3] Reads-from the Explicit Memory Write Effect of Location y on P0 generated by STR W2,[X3];
  * The Register X5 on P1 holds the value 1 in the end, because the Explicit Memory Read Effect of Location z on P1 generated by LDR W5,[X4] Reads-from the Explicit Memory Write Effect on P1;
  * The Register X6 on P1 holds the value 0 in the end, because the Explicit Memory Read Effect of Location x on P1 generated by LDR W6,[X1] Reads-from the initial state, and therefore is Coherence-before the Explicit Memory Write Effect of Location x on P0 generated by STR W0,[X1].
  ...
  * The value of x is 2 in the end, because the Explicit Memory Write Effect on P3 is Coherence-before the Explicit Memory Write Effect on P1;
  * The Register X3 on P0 holds the value 1 in the end, because the Explicit Memory Read Effect on P0 Reads-from the Explicit Memory Write Effect on P3;
  * The Register X3 on P1 holds the value 0 in the end, because the Explicit Memory Read Effect on P1 Reads-from the initial state, and therefore is Coherence-before the Explicit Memory Write Effect on P2;
  * The Register X4 on P3 holds the value 1 in the end, because the Explicit Memory Read Effect on P3 Reads-from the Explicit Memory Write Effect on P2.
  ...
  * The value of x is 2 in the end, because the Explicit Memory Write Effect on P2 is Coherence-before the Explicit Memory Write Effect of Location x on P1 generated by STR W0,[X1];
  * The Register X6 on P0 holds the value 1 in the end, because the Explicit Memory Read Effect on P0 Reads-from the Explicit Memory Write Effect on P2;
  * The Register X4 on P2 holds the value 1 in the end, because the Explicit Memory Read Effect on P2 Reads-from the Explicit Memory Write Effect of Location y on P1 generated by STR W2,[X3].
  ...
  * The Register X4 on P1 holds the value 1 in the end, because the Explicit Memory Read Effect of Location x on P1 generated by LDR W4,[X1] Reads-from the Explicit Memory Write Effect on P0;
  * The Register X3 on P1 holds the value 0 in the end, because the Explicit Memory Read Effect of Location y on P1 generated by LDR W3,[X2] Reads-from the initial state, and therefore is Coherence-before the Explicit Memory Write Effect on P2;
  * The Register X3 on P2 holds the value 0 in the end, because the Explicit Memory Read Effect on P2 Reads-from the initial state, and therefore is Coherence-before the Explicit Memory Write Effect on P3;
  * The Register X3 on P3 holds the value 0 in the end, because the Explicit Memory Read Effect on P3 Reads-from the initial state, and therefore is Coherence-before the Explicit Memory Write Effect on P0;
  * The value of y is 1 in the end, because the Store instruction on P2 has updated the memory;
  * The value of z is 1 in the end, because the Store instruction on P3 has updated the memory.
  ...
  * The Register X1 on P1 holds the value 1 in the end, because the Explicit Memory Read Effect on P1 Reads-from the Explicit Memory Write Effect on P0;
  * The Register X1 on P2 holds the value 1 in the end, because the Explicit Memory Read Effect of Location y on P2 generated by LDR W1,[X3] Reads-from the Explicit Memory Write Effect on P1;
  * The Register X4 on P2 holds the value 0 in the end, because the Explicit Memory Read Effect of Location x on P2 generated by LDR W4,[X0] Reads-from the initial state, and therefore is Coherence-before the Explicit Memory Write Effect on P0.
