Run litmus2desc on all tests in sorted order and compare output.
  ...
  * The CBNZ instruction on P1, i.e. CBNZ W1,LC00, creates a Control dependency from the Load instruction on P1, i.e. LDR W1,[X0], to the Store instruction on P1, i.e. STR W2,[X3];
  ...
  * The first Exclusive Or instruction in program order on P1, i.e. EOR W2,W0,W0, and the second Exclusive Or instruction in program order on P1, i.e. EOR W7,W6,W6, create an Address dependency from the first Load instruction in program order on P1, i.e. LDR W0,[X3], to the third Load instruction in program order on P1, i.e. LDR W8,[X1,W7,SXTW];
  ...
  * The Store instruction on P1, i.e. STR W4,[X5,W2,SXTW], generates an Explicit Memory Write Effect of Location z with value 1;
  * The second Load instruction in program order on P1, i.e. LDR W6,[X5], generates an Explicit Memory Read Effect of Location z;
  * The CBNZ instruction on P1, i.e. CBNZ W6,LC00, does not create any dependency from the first Load instruction in program order on P1, i.e. LDR W0,[X3], to the third Load instruction in program order on P1, i.e. LDR W7,[X1];
  * The CBNZ instruction on P1, i.e. CBNZ W6,LC00, does not create any dependency from the second Load instruction in program order on P1, i.e. LDR W6,[X5], to the third Load instruction in program order on P1, i.e. LDR W7,[X1];
  ...
  * The second Store instruction in program order on P0, i.e. STR W2,[X3], generates an Explicit Memory Write Effect of Location y with value 1;
  * The first Load instruction in program order on P1, i.e. LDR W0,[X3], generates an Explicit Memory Read Effect of Location y;
  * The CBNZ instruction on P1, i.e. CBNZ W0,LC00, creates a Control dependency from the first Load instruction in program order on P1, i.e. LDR W0,[X3], to the Store instruction on P1, i.e. STR W2,[X4];
  * The CBNZ instruction on P1, i.e. CBNZ W0,LC00, does not create any dependency from the first Load instruction in program order on P1, i.e. LDR W0,[X3], to the second Load instruction in program order on P1, i.e. LDR W5,[X4];
  * The CBNZ instruction on P1, i.e. CBNZ W0,LC00, does not create any dependency from the first Load instruction in program order on P1, i.e. LDR W0,[X3], to the third Load instruction in program order on P1, i.e. LDR W7,[X1,W6,SXTW];
  ...
  * The second Store instruction in program order on P0, i.e. STR W2,[X3], generates an Explicit Memory Write Effect of Location y with value 1;
  * The first Load instruction in program order on P1, i.e. LDR W0,[X3], generates an Explicit Memory Read Effect of Location y;
  * The first CBNZ instruction in program order on P1, i.e. CBNZ W0,LC00, creates a Control dependency from the first Load instruction in program order on P1, i.e. LDR W0,[X3], to the Store instruction on P1, i.e. STR W2,[X4];
  * The first CBNZ instruction in program order on P1, i.e. CBNZ W0,LC00, does not create any dependency from the first Load instruction in program order on P1, i.e. LDR W0,[X3], to the second Load instruction in program order on P1, i.e. LDR W5,[X4];
  * The Store instruction on P1, i.e. STR W2,[X4], generates an Explicit Memory Write Effect of Location z with value 1;
  * The second Load instruction in program order on P1, i.e. LDR W5,[X4], generates an Explicit Memory Read Effect of Location z;
  * The second CBNZ instruction in program order on P1, i.e. CBNZ W5,LC01, does not create any dependency from the second Load instruction in program order on P1, i.e. LDR W5,[X4], to the third Load instruction in program order on P1, i.e. LDR W6,[X1];
  ...
  * The first Exclusive Or instruction in program order on P1, i.e. EOR W2,W0,W0, and the second Exclusive Or instruction in program order on P1, i.e. EOR W6,W5,W5, create an Address dependency from the first Load instruction in program order on P1, i.e. LDR W0,[X3], to the third Load instruction in program order on P1, i.e. LDR W7,[X1,W6,SXTW];
  * The Store instruction on P1, i.e. STR W2,[X4], generates an Explicit Memory Write Effect of Location z with value 1;
  * The second Load instruction in program order on P1, i.e. LDR W5,[X4], generates an Explicit Memory Read Effect of Location z;
  ...
  * The Store instruction on P1, i.e. STR W2,[X4], generates an Explicit Memory Write Effect of Location z with value 1;
  * The second Load instruction in program order on P1, i.e. LDR W5,[X4], generates an Explicit Memory Read Effect of Location z;
  * The CBNZ instruction on P1, i.e. CBNZ W5,LC00, does not create any dependency from the first Load instruction in program order on P1, i.e. LDR W0,[X3], to the third Load instruction in program order on P1, i.e. LDR W6,[X1];
  * The CBNZ instruction on P1, i.e. CBNZ W5,LC00, does not create any dependency from the second Load instruction in program order on P1, i.e. LDR W5,[X4], to the third Load instruction in program order on P1, i.e. LDR W6,[X1];
  * The third Load instruction in program order on P1, i.e. LDR W6,[X1], generates an Explicit Memory Read Effect of Location x;
  * The Register X0 on P1 holds the value 1 in the end, which means that the Explicit Memory Read Effect of Location y on P1 generated by LDR W0,[X3] Reads-from the Explicit Memory Write Effect of Location y on P0 generated by STR W2,[X3];
  * The Register X5 on P1 holds the value 1 in the end, which means that the Explicit Memory Read Effect of Location z on P1 generated by LDR W5,[X4] Reads-from the Explicit Memory Write Effect on P1;
  * The Register X6 on P1 holds the value 0 in the end, which means that the Explicit Memory Read Effect of Location x on P1 generated by LDR W6,[X1] Reads-from the initial state, and therefore is Coherence-before the Explicit Memory Write Effect of Location x on P0 generated by STR W0,[X1];
