  $ litmus2desc -set-libdir ./libdir --latex --describe-dep-path rg_litmus_tests/MP.litmus
  ...
  \begin{itemize}
    ...
    \item The Register X4 on P1 holds the value 1 in the end, because the Explicit Memory Read Effect of Location y on P1 generated by LDR W4,[X3] Reads-from the Explicit Memory Write Effect of Location y on P0 generated by STR W2,[X3];
    \item The Register X6 on P1 holds the value 0 in the end, because the Explicit Memory Read Effect of Location x on P1 generated by LDR W6,[X1] Reads-from the initial state, and therefore is Coherence-before the Explicit Memory Write Effect of Location x on P0 generated by STR W0,[X1].
  \end{itemize}
  $ litmus2desc -set-libdir ./libdir --latex --describe-dep-path other_litmus_tests/MP+poll+poaa-amo.casal-pola.litmus
  ...
  \begin{itemize}
    ...
    \item The CASAL instruction on P1, i.e. CASAL W3,W4,[X2], generates an Explicit Memory Read Effect of Location z, and an Explicit Memory Write Effect of Location z with value 1;
  ...
  \begin{itemize}
    ...
    \item The Register X6 on P1 holds the value 0 in the end, because the Explicit Memory Read Effect of Location x on P1 generated by LDAR W6,[X5] Reads-from the initial state, and therefore is Coherence-before the Explicit Memory Write Effect of Location x on P0 generated by STLR W0,[X1].
  \end{itemize}
  $ litmus2desc -set-libdir ./libdir --latex --describe-dep-path rg_litmus_tests/PPODA.litmus
  This test asks whether the following execution is architecturally Allowed:
  ...
  \begin{itemize}
    ...
    \item The Register X0 on P1 holds the value 1 in the end, because the Explicit Memory Read Effect of Location y on P1 generated by LDR W0,[X3] Reads-from the Explicit Memory Write Effect of Location y on P0 generated by STR W2,[X3];
    \item The Register X5 on P1 holds the value 1 in the end, because the Explicit Memory Read Effect of Location z on P1 generated by LDR W5,[X4] Reads-from the Explicit Memory Write Effect on P1;
    \item The Register X7 on P1 holds the value 0 in the end, because the Explicit Memory Read Effect of Location x on P1 generated by LDR W7,[X1,W6,SXTW] Reads-from the initial state, and therefore is Coherence-before the Explicit Memory Write Effect of Location x on P0 generated by STR W0,[X1].
  \end{itemize}
