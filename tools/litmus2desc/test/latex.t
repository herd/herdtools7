  ...
  \begin{itemize}
    \item The first Store instruction in program order on P0, i.e. STR X0,[X1], generates an Explicit Memory Write Effect of Location x with value 1;
    \item The second Store instruction in program order on P0, i.e. STR X2,[X3], generates an Explicit Memory Write Effect of Location y with value 1;
    \item The first Load instruction in program order on P1, i.e. LDR X4,[X3], generates an Explicit Memory Read Effect of Location y;
    \item The second Load instruction in program order on P1, i.e. LDR X6,[X1], generates an Explicit Memory Read Effect of Location x;
    \item The Register X4 on P1 holds the value 1 in the end, which means that the Explicit Memory Read Effect of Location y on P1 generated by LDR X4,[X3] Reads-from the Explicit Memory Write Effect of Location y on P0 generated by STR X2,[X3];
    \item The Register X6 on P1 holds the value 0 in the end, which means that the Explicit Memory Read Effect of Location x on P1 generated by LDR X6,[X1] Reads-from the initial state, and therefore is Coherence-before the Explicit Memory Write Effect of Location x on P0 generated by STR X0,[X1].
  \end{itemize}
