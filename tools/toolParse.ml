...
module Top
    ...
    (B: functor(A:ArchBase.S)-> functor (Pte:PteVal.S) -> functor (Intid:IntidVal.S) ->
  ...
  let from_chan chan splitted =
    ...
    | `PPC ->
	  ...
	  let parser = MiscParser.mach2generic PPCParser.main
        ...
        let module X = Make (PPC) (PteVal.No) (IntidVal.No) (PPCLexParse) in
    ...
    | `X86 ->
	  ...
	  let parser = MiscParser.mach2generic X86Parser.main
        ...
        let module X = Make (X86) (PteVal.No) (IntidVal.No) (X86LexParse) in
        X.zyva chan splitted
    | `X86_64 ->
	  ...
	  let parser = MiscParser.mach2generic X86_64Parser.main
        ...
        let module X = Make (X86_64) (PteVal.No) (IntidVal.No) (X86_64LexParse) in
        X.zyva chan splitted
    | `ARM ->
	  ...
	  let parser = MiscParser.mach2generic ARMParser.main
        ...
        let module X = Make (ARM) (PteVal.No) (IntidVal.No) (ARMLexParse) in
        X.zyva chan splitted
    | `AArch64 ->
        let module AArch64 =
	  ...
	  let parser = (*MiscParser.mach2generic*) AArch64Parser.main
        ...
        let module X = Make (AArch64) (AArch64PteVal) (AArch64IntidVal) (AArch64LexParse) in
        X.zyva chan splitted
    | `MIPS ->
	  ...
	  let parser = MiscParser.mach2generic MIPSParser.main
        ...
        let module X = Make (MIPS) (PteVal.No) (IntidVal.No) (MIPSLexParse) in
        X.zyva chan splitted
    | `RISCV ->
	  ...
	  let parser = MiscParser.mach2generic RISCVParser.main
        ...
        let module X = Make (RISCV) (PteVal.No) (IntidVal.No) (RISCVLexParse) in
        X.zyva chan splitted
    | `LISA ->
	  ...
	  let parser = LISAParser.main
        ...
        let module X = Make (Bell) (PteVal.No) (IntidVal.No) (BellLexParse) in
        X.zyva chan splitted
    | `BPF ->
	  ...
	  let parser = MiscParser.mach2generic BPFParser.main
        ...
        let module X = Make (BPF) (PteVal.No) (IntidVal.No) (BPFLexParse) in
        X.zyva chan splitted
...
(* No macros *)
        ...
        let module X = B(C)(PteVal.No)(IntidVal.No) in
        let name =  splitted.Splitter.name in
        let parsed = P.parse chan splitted in
        X.zyva name parsed
