...
The following \synth{\NT{model-comment}} can be either a name or a string enclosed in double quotes~``\verb+"+''.
...
and to display pictures. Notice that the \synth{\NT{model-comment}} will appear
