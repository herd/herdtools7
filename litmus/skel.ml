...
(* Inserted source *)
      ...
      | A.Location_global (G.Pte _|G.Phy _|G.AddrT _|G.Tag _)
        -> assert false
...
(* Right value, all cases *)
      let rec dump_a_v = function
        ...
        | Symbolic _|Tag _|PteVal _|AddrReg _|IntidVal _|IntidUpdateVal _|Frozen _|ConcreteRecord _ -> assert false
