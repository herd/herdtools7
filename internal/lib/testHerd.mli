...
val mapply_herd_redirect_args :
  ...
  string list ->
  string list
(** [mapply_herd_redirect_args ?verbose ~j ~herd args] returns a list of
    arguments ready to be passed to mapply. These arguments will launch
    [herd_redirect.ext]. mapply is configured with additional redirection of
    output channels to conventional files. *)
